...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<'SQL'
        CREATE TABLE `add_vehicle_setting_detail`  (
          `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
          `add_vehicle_setting_id` bigint UNSIGNED NOT NULL,
          ...
          `upload_profile_photo_image_placeholder` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
          `choose_file_image_placeholder` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
          `images_option_placeholder` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
          `add_vehicle_button_text` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
          `car_photo_label` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
          `created_at` timestamp NULL DEFAULT NULL,
          `updated_at` timestamp NULL DEFAULT NULL,
          PRIMARY KEY (`id`) USING BTREE,
          INDEX `add_vehicle_setting_detail_add_vehicle_setting_id_foreign`(`add_vehicle_setting_id` ASC) USING BTREE,
          INDEX `add_vehicle_setting_detail_language_id_foreign`(`language_id` ASC) USING BTREE,
          CONSTRAINT `add_vehicle_setting_detail_add_vehicle_setting_id_foreign` FOREIGN KEY (`add_vehicle_setting_id`) REFERENCES `add_vehicle_setting` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
          CONSTRAINT `add_vehicle_setting_detail_language_id_foreign` FOREIGN KEY (`language_id`) REFERENCES `languages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
SQL);
    ...
    {
        DB::statement('DROP TABLE IF EXISTS `add_vehicle_setting_detail`');
    }
};
