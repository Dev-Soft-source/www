...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('edit_profile_page_setting_detail', function (Blueprint $table) {
            ...
            $table->string('address_error')->nullable();
            $table->string('zip_code_error')->nullable();
            $table->string('government_issued_error')->nullable();
    ...
    public function down()
    {
        Schema::table('edit_profile_page_setting_detail', function (Blueprint $table) {
            $table->dropColumn(['bio_error', 'zip_code_error', 'city_error', 'state_error', 'country_error', 'dob_error',
                'gender_error', 'last_name_error', 'first_name_error', 'government_issued_error', 'address_error'
            ]);
        });
    }
};
