...
return [
    ...
    'custom' => [
        ...
        'origin' => [
            'message' => "Поле відправлення є обов'язковим.",
        ],
        'destination' => [
            'message' => "Поле призначення є обов'язковим.",
        ],
        'origin.label' => [
            'required' => "Поле відправлення є обов'язковим.",
            'required_without' => "Поле відправлення є обов'язковим."
        ],
        'destination.label' => [
            'required' => "Поле призначення є обов'язковим.",
            'required_without' => "Поле призначення є обов'язковим."
        ],
        'date' => [
        ...
        'price_minor' => [
            ...
            'gt' => 'Ціна повинна бути більше 0.',
        ],
        'stops.*.label' => ['required_with' => "Місце зупинки є обов'язковим для кожної зупинки."],
        'stops.*.departure_at' => ['required_with' => "Час відправлення є обов'язковим для кожної зупинки."],
        'stops.*.pickup_dropoff_location.required_with' => "Місце посадки/висадки є обов'язковим.",
        'from' => [
            'required' => "Поле відправлення є обов'язковим.",
        ],
        'to' => [
        ...
        'rideshare_disclaimer' => [
            'required' => 'Це підтвердження є обов\'язковим перед продовженням.',
            'accepted' => 'Це підтвердження є обов\'язковим перед продовженням.',
        ],
        'gender' => [
        ...
        'phone' => [
            ...
            'valid' => 'Будь ласка, введіть дійсний номер телефону.',
            'unique' => 'Обліковий запис з цим номером телефону вже існує.',
        ],
        'full_phone' => [
            'max' => 'Номер телефону повинен містити менше 20 символів.',
        ...
        'student_card' => [
            'required' => 'Студентський квиток є обов\'язковим.',
            'mimes' => 'Зображення має бути файлом типу: jpeg, png, jpg, gif, pdf.',
            'max' => 'Зображення має бути менше 10 МБ.',
        ],

        'payment_method' => [
            'required' => 'Поле способу оплати є обов’язковим.',
        ],
        'card_id' => [
            'required' => 'Будь ласка, оберіть варіант оплати.',
        ],
        'dr_amount' => [
            'required' => 'Поле суми є обов’язковим.',
        ],
        'dr_amount.gt' => 'Сума повинна бути більшою за 0.',
    ],
    'attributes' => [
        'make' => 'Марка',
        'model' => 'Модель',
        ...
        'color' => 'Колір',
        'year' => 'Рік',
        'license_no' => 'Номерний знак',
        'power_type' => 'Джерело енергії',
