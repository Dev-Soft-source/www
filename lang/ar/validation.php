...
return [
    ...
    'custom' => [
        ...
        'rideshare_disclaimer' => [
            'required' => 'هذا الإقرار مطلوب قبل المتابعة.',
            'accepted' => 'هذا الإقرار مطلوب قبل المتابعة.',
        ],
        'gender' => [
        ...
        'phone' => [
            ...
            'valid' => 'يرجى إدخال رقم هاتف صالح.',
            'unique' => 'يوجد بالفعل حساب بهذا الرقم.',
        ],
        'full_phone' => [
            'max' => 'يجب أن يكون رقم الهاتف أقل من 20 حرفاً.',
            'unique' => 'تم استخدام هذا الرقم مسبقاً.',
        ],
        'message' => [
