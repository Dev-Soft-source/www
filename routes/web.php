...
Route::get('{lang?}/my-passengers/{ride_id}', [MyRideController::class, 'MyPassengers'])->name('my_passengers');
...
Route::get('{lang?}/booking/{id}/{from_stop_id?}/{to_stop_id?}', [BookingController::class, 'create'])->name('booking')->middleware('auth');//->middleware('nocache');
...
Route::get('{lang?}/disclaimer', [DisclaimerController::class, 'index'])->name('disclaimer');
Route::get('{lang?}/for-tourists', [ForTouristsController::class, 'index'])->name('for_tourists');
Route::get('{lang?}/community-guidelines', [CommunityGuidelinesController::class, 'index'])->name('community_guidelines');
