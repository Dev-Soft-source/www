  ...
  Future getMyReferralData(token, langId) async {
    try {
      final response = await getConnect
          .get("$baseUrl/$myReferralList?lang_id=$langId", headers: {
      ...
      logger.error("HTTP error in getMyReferralData: $e");
      return Future.error({
        "type": "server",
        "message": "Server error occurred. Please try again later."
      });
    } catch (exception) {
      logger.error("Unknown error in getMyReferralData: $exception");
