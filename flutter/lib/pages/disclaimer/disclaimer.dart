...
class _DisclaimerPageState extends State<DisclaimerPage> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
          Uri.parse('$url/${serviceController.lang.value}/disclaimer'));
  }

  @override
  Widget build(BuildContext context) {
    final String pageUrl =
        '$url/${serviceController.lang.value}/disclaimer';
    return Scaffold(
      appBar: AppBar(
        backgroundColor: primaryColor,
        title: secondAppBarWidget(title: "Disclaimer", context: context),
