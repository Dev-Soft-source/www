              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      txt20SizeCapitalize(title: "${booking['passenger']['first_name']}", context: context),
                      5.heightBox,
                      txt20Size(context: context, title: "$ageLabel: ${booking['passenger']['age']}  ${booking['passenger']['gender_label']} $reviewLabel: ${booking['passenger']['average_rating'] != null ? booking['passenger']['average_rating'].ceil() : "0" }", fontFamily: bold),
                      5.heightBox,
                      txt20Size(context: context, title: "${booking['seats']} $seatRequestLabel", textColor: primaryColor),
                    ],
                  )
                ],
              ),
