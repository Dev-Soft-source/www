...
Widget vehicleInfoWidget({context, String vehicleDetail = "", String vehicleImage = "", String vehicleId = "", String licenseNumber = "",  String carType = "",String rideId = "",
  ...
  // Check if there's a vehicle - if vehicleId is not empty (and not "null" string) or vehicleDetail is not empty
  bool hasVehicle = (vehicleId.isNotEmpty && vehicleId.toLowerCase() != "null") || vehicleDetail.trim().isNotEmpty;
        ...
        widgetChild: Column(
          ...
          children: [
            ...
            if (hasVehicle) ...[
              ...
              // Empty container to maintain spacing when no vehicle
              Container(
                padding: EdgeInsets.fromLTRB(getValueForScreenType<double>(
                  context: context,
                  mobile: 15.0,
