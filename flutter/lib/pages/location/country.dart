                      ...
                      child: SingleChildScrollView(
                        ...
                        children: [
                          fieldsWidget(
                              ...
                              readonly: false,
                              placeHolder:
                                  "${controller.labelTextDetail['search_country_label'] ?? "Search country here"}",
                              suffix: const Icon(
                                Icons.search,
                                color: textColor,
                              ),
                          ...
                          controller.searchCountries.isNotEmpty
                                  ...
                                  itemBuilder: (context, index) {
                                    return dropDownItemWidget(
                                        ...
                                        onTap: () async {
                                          ...
                                          controller.tempController.countryId
                                                  .value =
                                              controller.searchCountries[index]
                                                  ['id'];
                                          controller.tempController.countryName
                                                  .value =
                                              controller.searchCountries[index]
                                                  ['name'];
                                          controller.tempController.states
                                              .clear();
                                          controller.tempController.cities
                                              .clear();
                                          controller
                                              .tempController.stateId.value = 0;
                                          controller.tempController.stateName
                                              .value = "";
                                          controller
                                              .tempController.cityId.value = 0;
                                          controller.tempController.cityName
                                              .value = "";
                                          Get.back();
                                        },
                                        name:
                                            "${controller.searchCountries[index]['name']}",
                              ...
                              : Center(
                                  child: txt20Size(
                                      title:
                                          "${controller.labelTextDetail['no_country_label'] ?? "No countries found!"}",
                                      context: context,
                                      fontFamily: regular))
                        ],
                      ))),
