        ...
        appBar: AppBar(
          ...
          title: Obx(() => secondAppBarWidget(
              title: controller.isCity.value == "city"
                  ? "${controller.labelTextDetail['select_city_label'] ?? "Select city"}"
                  : controller.isCity.value == "origin"
                      ? "${controller.labelTextDetail['select_origin_label'] ?? "Select origin"}"
                      : controller.isCity.value == "destination"
                      ...
                      children: [
                        fieldsWidget(
                            ...
                            placeHolder: controller.isCity.value == "city"
                                ? "${controller.labelTextDetail['search_city_label'] ?? "Search city here"}"
                                : controller.isCity.value == "origin"
                                    ? "${controller.labelTextDetail['search_origin_label'] ?? "Search origin here"}"
                                    : controller.isCity.value == "destination"
                        ...
                        controller.searchCities.isNotEmpty
                                ...
                                itemBuilder: (context, index) {
                                  return dropDownItemWidget(
                                      ...
                                      onTap: () async {
                                        ...
                                        if (controller.isCity.value == "city") {
                                          controller
                                              ...
                                              controller.searchCities[index]
                                                  ['id'];
                                          controller.tempController.cityName
                                                  .value =
                                              "${controller.searchCities[index]['name']}, ${controller.searchCities[index]['state']['abrv']}, ${controller.searchCities[index]['state']['country']['name']}";
                                        ...
                                        if (controller
                                            .isPostRideControllerRegistered) {
                                          if (controller.spot.value == "yes") {
                                            if (controller.isCity.value ==
                                                "origin") {
                                            } else if (controller
                                                    .isCity.value ==
                                                "destination") {}
                                            ...
                                            if (controller.isCity.value ==
                                                "origin") {
                                              if (controller
                                                  .tempController.errors
                                                  .any((error) =>
                                                      error['title'] ==
                                                      "from")) {
                                                controller.tempController.errors
                                                    .removeWhere((error) =>
                                                        error['title'] ==
                                                        "from");
                                              }
                            ...
                            : Center(
                                child: txt20Size(
                                    title: controller.isCity.value == "city"
                                        ? "${controller.labelTextDetail['no_city_label'] ?? "No cities found!"}"
                                        : controller.isCity.value == "origin"
                                            ? "${controller.labelTextDetail['no_origin_label'] ?? "No origin found!"}"
                                            : controller.isCity.value ==
                                                    "destination"
