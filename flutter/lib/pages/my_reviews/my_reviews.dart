      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Obx(() => secondAppBarWidget(
              context: context,
              title:
                  "${controller.labelTextDetail['main_heading'] ?? "My reviews"}")),
                    ...
                    child: Column(
                      ...
                      children: [
                        TabBar(
                          ...
                          tabs: [
                            Text(
                                "${controller.labelTextDetail['review_received_label'] ?? "Reviews I received"}"),
                            Text(
                                "${controller.labelTextDetail['review_left_label'] ?? "Reviews I left"}")
                          ],
                        ),
                        Expanded(
                            child: PageView(
                            ...
                            controller.reviewsReceived.isNotEmpty
                                ? SingleChildScrollView(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ListView.separated(
                                          itemCount:
                                              controller.reviewsReceived.length,
                                          shrinkWrap: true,
                                          physics:
                                          ...
                                          itemBuilder: (context, index) {
                                            return InkWell(
                                              onTap: () {
                                                Get.toNamed(
                                                    '/review_detail/${controller.reviewsReceived[index]['id']}/from/driver');
                                              },
                                              child: reviewCard(
                                                ...
                                                review: controller
                                                        .reviewsReceived[index]
                                                    ['review'],
                                                image:
                                                    "${controller.reviewsReceived[index]['from']['profile_image']}",
                                                addedOn: controller
                                                        .reviewsReceived[index]
                                                    ['added_on'],
                                                rating: controller.reviewsReceived[
                                                                index][
                                                            'average_rating'] !=
                                                        null
                                                ...
                                                showReply:
                                                    (controller.reviewsReceived[
                                                        ...
                                                        : true,
                                                responseLabel:
                                                    "${controller.labelTextDetail['response_label'] ?? "response"}",
                                                repliedLabel:
                                                    "${controller.labelTextDetail['replied_label'] ?? "replied"}",
                                                replyLabel:
                                                    "${controller.labelTextDetail['reply_label'] ?? "Reply"}",
                                                replyHeadingLabel:
                                                    "${controller.labelTextDetail['reply_heading_label'] ?? "Reply"}",
                                                replyPlaceholder:
                                                    "${controller.labelTextDetail['reply_placeholder'] ?? "Enter your reply"}",
                                                replySubmitButtonLabel:
                                                    "${controller.labelTextDetail['reply_submit_button_label'] ?? "Submit"}",
                                                onSubmit: () {
                                                  controller.addReply(
                                                      controller
                                                              .reviewsReceived[
                                        ...
                                        if (controller
                                                .receivedNoMoreData.value ==
                                            true) ...[
                                          30.heightBox,
                                          Center(
                                              child: txt20Size(
                                                  title:
                                                      "${controller.labelTextDetail['no_more_data_label'] ?? "No more data"}",
                                                  context: context)),
                                          30.heightBox,
                                        ],
                                        if (controller.receivedLoadMore.value ==
                                            true) ...[
                                          30.heightBox,
                                          Center(
                                ...
                                : Center(
                                    ...
                                    children: [
                                      ...
                                      txt20Size(
                                          title:
                                              "${controller.labelTextDetail['no_received_message'] ?? "You have not received any reviews yet"}",
                                          context: context),
                                    ],
                                  )),
                            controller.reviewsLeft.isNotEmpty
                                ? SingleChildScrollView(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ListView.separated(
                                          ...
                                          itemBuilder: (context, index) {
                                            return InkWell(
                                              onTap: () {
                                                Get.toNamed(
                                                    '/review_detail/${controller.reviewsLeft[index]['id']}/to/passenger');
                                              },
                                              child: reviewCard(
                                                  reviewCardColor: index % 2 == 0
                                                      ? Colors.white
                                                  ...
                                                  bottomSheetHeight:
                                                      (context.screenHeight / 2) +
                                                          50,
                                                  name:
                                                      "${controller.reviewsLeft[index]['to']['first_name']} ${controller.reviewsLeft[index]['to']['last_name']}",
                                                  review: controller.reviewsLeft[index]
                                                      ['review'],
                                                  image:
                                                      "${controller.reviewsLeft[index]['to']['profile_image']}",
                                                  addedOn: controller.reviewsLeft[index]
                                                      ['added_on'],
                                                  rating: controller.reviewsLeft[index]['average_rating'] != null
                                                      ? double.parse(controller
                                                              .reviewsLeft[index]
                                                          ['average_rating'])
                                                      : 0,
                                                  replied: (controller.reviewsLeft[index]
                                                              ['replies'] !=
                                                          null)
                                                      ? controller.reviewsLeft[index]
                                                          ['replies']['reply']
                                                      : '',
                                        ...
                                        if (controller.leftNoMoreData.value ==
                                            true) ...[
                                          30.heightBox,
                                          Center(
                                              child: txt20Size(
                                        ...
                                        if (controller.leftLoadMore.value ==
                                            true) ...[
                                          30.heightBox,
                                          Center(
                                              child: progressCircularWidget(
                                ...
                                : Center(
                                    ...
                                    children: [
                                      ...
                                      txt20Size(
                                          title:
                                              "${controller.labelTextDetail['no_left_message'] ?? "You have not left any reviews yet"}",
                                          context: context),
                                    ],
                                  )),
                          ],
