                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          // txt22Size(
                          //     // title: formatMessage(
                          //     //     "To use Pink Rides and Extra-Care Rides as a driver or passenger, your phone number must be verified. You may also update your phone number here."),
                          //     title: formatMessage(
                          ...
                          ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                return phoneNumberCardWidget(
                                    ...
                                    context: context,
                                    def: controller.numbersList[index]
                                        ['default'],
                                    number: controller.numbersList[index]
                                        ['phone'],
                                    verification: controller.numbersList[index]
                                        ['verified'],
                                    controller: controller,
                                    onVerify: () {
                                      controller.sendVerificationCode(
                                          phoneId: controller.numbersList[index]
                                              ['id']);
                                    },
                                    onDelete: () {
                                      controller.deletePhoneNumber(
                                          controller.numbersList[index]['id'],
                                          index);
                                    },
                                    onSetDefault: () {
                                      controller.setAsDefaultNumber(
                                          controller.numbersList[index]['id'],
                                          index);
                                    });
                              },
                              ...
                              Expanded(
                                child: elevatedButtonWidget(
                                    textWidget: txt22Size(
                                        title:
                                            "${controller.labelTextDetail['save_phoneno_button_text'] ?? "Save Unverified for Now"}",
                                        fontFamily: regular,
                                    ...
                                    btnRadius: 5.0,
                                    enabled:
                                        controller.isNewPhoneFormValid.value),
                              ),
                            ],
                          ),
                            ...
                            children: [
                              Expanded(
                                child: elevatedButtonWidget(
                                    textWidget: txt22Size(
                                        title:
                                            "${controller.labelTextDetail['send_verification_code_button_text'] ?? "Send verification code"}",
                                        fontFamily: regular,
                                        textColor: Colors.white,
                                        context: context),
                                    onPressed: () {
