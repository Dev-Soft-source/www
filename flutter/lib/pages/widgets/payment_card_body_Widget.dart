    ...
    child: Row(
      ...
      children: [
        ...
        Column(
          ...
          children: [
            // Card masked number and type should use normal text size (20px)
            txt20Size(title: maskedCardNumber, context: context),
            txt20SizeCapitalize(title: cardType, context: context)
          ],
        )
      ],
    ),
