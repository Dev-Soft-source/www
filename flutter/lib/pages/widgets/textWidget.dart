...
Widget txt14SizeWithOutContext(
    {String title = "",
    String fontFamily = regular,
    Color textColor = textColor}) {
  return Text(
...
Widget txt16SizeWithOutContext(
    {String title = "",
    String fontFamily = regular,
    Color textColor = textColor}) {
  return Text(
...
Widget textWithUnderLine(
    ...
    context,
    double textSize = 0.0,
    Color decorationColor = primaryColor}) {
  return Text(
    title,
    style: TextStyle(
