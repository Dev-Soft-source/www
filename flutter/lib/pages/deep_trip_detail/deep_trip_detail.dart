                        ...
                        children: [
                         ...
                         if(controller.ride['booking_requests'].isNotEmpty)...[
                          ...
                          if(controller.ride['seats_left'] != null && controller.ride['seats_left'] <= 0)...[
                            10.heightBox,
                            Center(child: txt20Size(title: "${controller.labelTextDetail['all_seats_booked_label'] ?? "This ride is fully booked"}", fontFamily: regular, context: context,textColor: Colors.red)),
                          ],
                          10.heightBox,
