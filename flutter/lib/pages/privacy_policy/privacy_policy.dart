...
class _PrivacyPolicyPageState extends State<PrivacyPolicyPage> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
          Uri.parse('$url/${serviceController.lang.value}/privacy-policy'));
  }

  @override
  Widget build(BuildContext context) {
    final String pageUrl =
        '$url/${serviceController.lang.value}/privacy-policy';
    return Scaffold(
      appBar: AppBar(
        backgroundColor: primaryColor,
        title: secondAppBarWidget(title: "Privacy Policy", context: context),
