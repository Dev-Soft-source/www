  ...
  return Container(
      ...
      child: Column(
        ...
        children: [
          postRideWidget(
              title:
                  "${controller.labelTextDetail['vehicle_label'] ?? "Vehicle"}",
              ...
              children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: txt20Size(
                                title:
                                    "${controller.labelTextDetail['skip_label'] ?? "Skip for now"}",
                                context: context,
                                fontFamily: bold,
                                textColor: textColor),
                          )
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: bookingCheck == true || controller.addNewVehicle.value
                                  ...
                                  : () {
                                      controller.addNewVehicle.value =
                                          controller.addNewVehicle.value == true
                                              ? false
                                              : true;
                                      controller.skipNow.value = false;
                                      controller.alreadyAdded.value = false;
                              ...
                              child: txt20Size(
                                  title:
                                      "${controller.labelTextDetail['add_vehicle_label'] ?? "Add new vehicle"}",
                                  context: context,
                                  fontFamily: bold),
                            ),
                          ],
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: bookingCheck == true || controller.alreadyAdded.value
                                  ...
                                  : () {
                                      controller.alreadyAdded.value =
                                          controller.alreadyAdded.value == true
                                              ? false
                                              : true;
                                      controller.addNewVehicle.value = false;
                                      controller.skipNow.value = false;
                              ...
                              child: txt20Size(
                                  title: controller.vehicleList.isNotEmpty
                                      ? "${controller.vehicleList.firstWhere((v) => v['id'].toString() == controller.vehicleId.value, orElse: () => controller.vehicleList[0])['year']} ${controller.vehicleList.firstWhere((v) => v['id'].toString() == controller.vehicleId.value, orElse: () => controller.vehicleList[0])['make']} ${controller.vehicleList.firstWhere((v) => v['id'].toString() == controller.vehicleId.value, orElse: () => controller.vehicleList[0])['model']}"
                                      : "${controller.labelTextDetail['existing_label'] ?? "Existing"}",
                                  context: context,
                                  fontFamily: bold,
                                  textColor: textColor),
                            )
                ...
                if (controller.addNewVehicle.value == true) ...[
                  ...
                  fieldsWidget(
                    ...
                    fontSize: 18.0,
                    placeHolder:
                        "${controller.labelTextDetail['make_placeholder'] ?? "Example: Honda"}",
                    onChanged: (value) {
                      if (controller.errors
                          .any((error) => error['title'] == "make")) {
                        controller.errors
                            .removeWhere((error) => error['title'] == "make");
                      }
                    },
                  ...
                  if (controller.errors
                    ...
                    toolTip(
                        tip: controller.errors
                            .firstWhere((error) => error['title'] == "make"))
                  ],
                  10.heightBox,
                  txt20Size(
                      title:
                  ...
                  fieldsWidget(
                    ...
                    fontSize: 18.0,
                    placeHolder:
                        "${controller.labelTextDetail['model_placeholder'] ?? "Example: Accord"}",
                    onChanged: (value) {
                      if (controller.errors
                          .any((error) => error['title'] == "model")) {
                        controller.errors
                            .removeWhere((error) => error['title'] == "model");
                      }
                    },
                    isError: controller.errors
                  ...
                  if (controller.errors
                    ...
                    toolTip(
                        tip: controller.errors
                            .firstWhere((error) => error['title'] == "model"))
                  ],
                  10.heightBox,
                  txt20Size(
                      title:
                          "${controller.labelTextDetail['liscense_label'] ?? "License plate number"}",
                      fontFamily: regular,
                      context: context),
                  5.heightBox,
                  fieldsWidget(
                    ...
                    onChanged: (value) {
                      if (controller.errors
                          .any((error) => error['title'] == "license_no")) {
                        controller.errors.removeWhere(
                            (error) => error['title'] == "license_no");
                      }
                    },
                    isError: controller.errors
                  ...
                  fieldsWidget(
                    ...
                    onChanged: (value) {
                      if (controller.errors
                          .any((error) => error['title'] == "color")) {
                        controller.errors
                            .removeWhere((error) => error['title'] == "color");
                      }
                    },
                    isError: controller.errors
                  ...
                  if (controller.errors
                    ...
                    toolTip(
                        tip: controller.errors
                            .firstWhere((error) => error['title'] == "color"))
                  ],
                  10.heightBox,
                  txt20Size(
                      title:
                  ...
                  fieldsWidget(
                    ...
                    onChanged: (value) {
                      if (controller.errors
                          .any((error) => error['title'] == "year")) {
                        controller.errors
                            .removeWhere((error) => error['title'] == "year");
                      }
                    },
                    isError: controller.errors
                  ...
                  if (controller.errors
                    ...
                    toolTip(
                        tip: controller.errors
                            .firstWhere((error) => error['title'] == "year"))
                  ],
                  10.heightBox,
                  txt20Size(
                      title:
                          "${controller.labelTextDetail['type_label'] ?? "Vehicle type"}",
                      fontFamily: regular,
                      context: context),
                  5.heightBox,
                  Container(
                        ...
                        for (var i = 0;
                          ...
                          DropdownMenuItem(
                            ...
                            child: controller.vehicleType.value ==
                                ...
                                : txt18Size(
                                    title: controller.vehicleTypeLabelList[i],
                                    context: context,
                                    fontFamily: bold),
                          ),
                        ],
                  ...
                  if (error
                      .any((error) => error['title'] == "vehicle_type")) ...[
                    toolTip(
                        tip: error.firstWhere(
                            (error) => error['title'] == "vehicle_type"))
                  ],
                  10.heightBox,
                  txt20Size(
                      title:
                          "${controller.labelTextDetail['car_type_label'] ?? "Fuel"}",
                      fontFamily: regular,
                      context: context),
                  5.heightBox,
                  Row(
                        ...
                        children: [
                            ...
                            child: checkBoxWidget(
                                ...
                                onChanged: bookingCheck == true
                                    ...
                                    : (value) async {
                                        ...
                                        if (controller.fuel.value.isNotEmpty &&
                                            controller.errors.any((error) =>
                                                error['title'] == "car_type")) {
                                          controller.errors.removeWhere(
                                              (error) =>
                                                  error['title'] == "car_type");
                                        }
                          ...
                          InkWell(
                            onTap: bookingCheck == true
                                ...
                                : () {
                                    controller.fuel.value =
                                        controller.fuel.value == "Electric car"
                                            ? ""
                                            : "Electric car";
                                    if (controller.fuel.value.isNotEmpty &&
                                        controller.errors.any((error) =>
                            ...
                            child: txt20Size(
                                title:
                                    "${controller.labelTextDetail['electric_car_label'] ?? "Electric"}",
                                context: context,
                                fontFamily: regular),
                          )
                        ],
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: bookingCheck == true
                                ...
                                : () {
                                    controller.fuel.value =
                                        controller.fuel.value == "Hybrid car"
                                            ? ""
                                            : "Hybrid car";
                                    if (controller.fuel.value.isNotEmpty &&
                                        controller.errors.any((error) =>
                            ...
                            child: txt20Size(
                                title:
                                    "${controller.labelTextDetail['hybrid_car_label'] ?? "Hybrid"}",
                                context: context,
                                fontFamily: regular),
                          )
                        ],
                      ...
                      Row(
                        children: [
                          ...
                          InkWell(
                            ...
                            child: txt20Size(
                                title:
                                    "${controller.labelTextDetail['gas_car_label'] ?? "Gas"}",
                                context: context,
                                fontFamily: regular),
                          )
                        ],
                  ...
                  // When using an existing vehicle, we now rely on the
                  // checked checkbox label above to show the selected vehicle
                  // (primary or the only one). No dropdown is shown anymore.
                ],
              ],
            ),
          ),
