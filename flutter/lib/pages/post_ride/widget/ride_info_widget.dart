  ...
  return Container(
      ...
      child: Column(
        ...
        children: [
          postRideWidget(
              title:
                  "${controller.labelTextDetail['ride_info_heading'] ?? "Ride Info"}",
            ...
            child: Column(
              ...
              children: [
                ...
                fieldsWidget(
                  ...
                  onChanged: (value) {
                    if (controller.errors
                      ...
                      controller.errors
                          .removeWhere((error) => error['title'] == "from");
                    }
                  },
                ...
                if (controller.errors
                  ...
                  toolTip(
                      tip: controller.errors
                          .firstWhere((error) => error['title'] == "from"))
                ],
                10.heightBox,
                Row(
                  children: [
                ...
                fieldsWidget(
                  ...
                  onChanged: (value) {
                    if (controller.errors
                        .any((error) => error['title'] == "to")) {
                      controller.errors
                          .removeWhere((error) => error['title'] == "to");
                    }
                  },
                  isError: controller.errors
                ...
                textAreaWidget(
                  ...
                  onChanged: (value) {
                    if (controller.errors
                      ...
                      controller.errors
                          .removeWhere((error) => error['title'] == "pickup");
                    }
                  },
                  isError: controller.errors
                ...
                textAreaWidget(
                  ...
                  onChanged: (value) {
                    if (controller.errors
                      ...
                      controller.errors
                          .removeWhere((error) => error['title'] == "dropoff");
                    }
                  },
                  isError: controller.errors
                ...
                if (controller.errors
                  ...
                  toolTip(
                      tip: controller.errors
                          .firstWhere((error) => error['title'] == "dropoff"))
                ],
                10.heightBox,
                Row(
                  children: [
                    ...
                    Expanded(
                      child: dateFieldWidget(
                        ...
                        onTap: bookingCheck == true
                            ? null
                            : () async {
                                TimeOfDay? picked = await controller
                                    .serviceController
                                    .timePicker(context);
                                ...
                                if (controller
                                    .dateTextEditingController.text.isEmpty) {
                                ...
                                DateTime dateFromString = dateFormat.parse(
                                    controller.dateTextEditingController.text);
                                ...
                                if (dateFromString
                                        .isAtSameMomentAs(currentDateOnly) &&
                                    picked.hour < nowTime.hour) {
                                  controller.serviceController.showDialogue(
                      ...
                      onTap: bookingCheck == true
                          ...
                          : () {
                              controller.recurring.value =
                                  controller.recurring.value == true
                                      ? false
                                      : true;
                            },
                      child: txt20Size(
                          title:
                              "${controller.labelTextDetail['recurring_label'] ?? "Recurring trip"}",
                          context: context,
                          fontFamily: bold),
                    ),
                  ],
                ...
                if (controller.recurring.value == true) ...[
                  ...
                  txt20Size(
                      title:
                          "${controller.labelTextDetail['recurring_type_label'] ?? "Recurring type"}",
                      fontFamily: regular,
                      context: context),
                  3.heightBox,
                  Container(
                    ...
                    child: DropdownButtonFormField(
                        ...
                        items: [
                          DropdownMenuItem(
                            ...
                            child: txt18Size(
                                title:
                                    "${controller.labelTextDetail['recurring_type_select_placeholder'] ?? "Select"}",
                                context: context,
                                fontFamily: bold,
                                textColor: textColor),
                          ),
                          DropdownMenuItem(
                              ...
                              child: Container(
                                child: txt18Size(
                                    title:
                                        "${controller.labelTextDetail['recurring_type_daily_label'] ?? "Daily"}",
                                    context: context,
                                    fontFamily: bold,
                                    textColor: textColor),
                              )),
                          DropdownMenuItem(
                            ...
                            child: txt18Size(
                                title:
                                    "${controller.labelTextDetail['recurring_type_weekly_label'] ?? "Weekly"}",
                                context: context,
                                fontFamily: bold,
                                textColor: textColor),
                          ),
                  ...
                  txt20Size(
                      title:
                          "${controller.labelTextDetail['recurring_trips_label'] ?? "Recurring trips"}",
                      fontFamily: regular,
                      context: context),
                  3.heightBox,
                  fieldsWidget(
                    ...
                    fontSize: 16.0,
                    placeHolder:
                        "${controller.labelTextDetail['recurring_trips_placeholder'] ?? "Enter a number, example: 10"}",
                    isError: controller.errors
