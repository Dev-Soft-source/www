  ...
  return Container(
      ...
      child: Column(
        ...
        children: [
          postRideWidget(
              title:
                  "${controller.labelTextDetail['meeting_drop_off_description_label'] ?? "Meeting and drop-off description"}",
                    ...
                    textAreaWidget(
                      ...
                      onChanged: (value) {
                        if (controller.errors
                            .any((error) => error['title'] == "details")) {
                          controller.errors.removeWhere(
                              (error) => error['title'] == "details");
                        }
                      },
                ...
                if (controller.errors
                  ...
                  toolTip(
                      tip: controller.errors
                          .firstWhere((error) => error['title'] == "details"))
                ],
              ],
            ),
          ),
