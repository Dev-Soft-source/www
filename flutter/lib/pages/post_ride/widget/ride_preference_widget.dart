  ...
  return Container(
      ...
      child: Column(
        ...
        children: [
          postRideWidget(
              title:
                  "${controller.labelTextDetail['preferences_label'] ?? "Ride preference"}",
            ...
            child: Column(
              ...
              children: [
                        ...
                        for (var i = 0;
                          ...
                          checkBoxSelectionWidget(
                            ...
                            onChanged: bookingCheck == true
                                ? null
                                : i == 0 &&
                                        controller.pinkRideReadOnly.value ==
                                            true
                                    ? null
                                    : i == 1 &&
                                            controller.extraCareRideReadOnly
                                                    .value ==
                                                true
                                        ? null
                                        : (value) async {
                                            if (controller.errors.any((error) =>
                                                error['title'] == "features")) {
                ...
                if (error.any((error) => error['title'] == "features")) ...[
                  toolTip(
                      tip: error
                          .firstWhere((error) => error['title'] == "features"))
                ],
              ],
            ),
          ),
