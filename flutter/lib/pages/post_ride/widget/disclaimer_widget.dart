          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                txt20Size(
                    title:
                        "${controller.labelTextDetail['app_disclaimers_description3'] ?? "3. Any cancellation will demand, approve from me and that if I exceed a quote of cancellations (more than two rides for every three months) without a good reason,I will incur a penalty"}",
                    fontFamily: bold,
                    context: context),
                const Divider(color: inputColor),
                txt20Size(
                    title:
                        "${controller.labelTextDetail['app_disclaimers_description4'] ?? "4. If a passenger does not show up on time, and I want to leave without them, I will call the passenger to ask where they are. I will also gather evidence to prove that I was present at the meeting place on time"}",
                    fontFamily: bold,
                    context: context),
              ],
            ),
