  ...
  return Container(
      ...
      child: Column(
        ...
        children: [
          postRideWidget(
              title:
                  "${controller.labelTextDetail['anything_to_add_label'] ?? "Anything to add?"}",
            ...
            child: Column(
              ...
              children: [
                textAreaWidget(
                  ...
                  fontFamily: regular,
                  placeHolder:
                      "${controller.labelTextDetail['anything_to_add_placeholder'] ?? "What else do you want to tell your passengers?"}",
                  maxLines: 5,
                  hintMaxLines: 50,
                  maxLength: 1800,
                  onChanged: (value) {
                    if (controller.errors
                        .any((error) => error['title'] == "notes")) {
                      controller.errors
                          .removeWhere((error) => error['title'] == "notes");
                    }
                  },
                ...
                if (controller.errors
                  ...
                  toolTip(
                      tip: controller.errors
                          .firstWhere((error) => error['title'] == "notes"))
                ],
              ],
            ),
          ),
