        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                for (var i = 0;
                    i < controller.cancellationOptionList.length;
                    i++) ...[
                  Container(
                    ...
                    child: checkBoxSelectionWidget(
                      context: context,
                      title:
                          "${controller.cancellationOptionLabelList[i]} ${i == 1 ? "(${controller.labelTextDetail['cancellation_policy_discount_label'] ?? "discount"} ${controller.firmCancellationPrice.value}%)" : ""}",
                      showToolTipBottom: true,
                      infoText: "See our Cancellation Policy for details.",
          ...
          if (error.any((error) => error['title'] == "booking_type")) ...[
            Padding(
              ...
              child: toolTip(
                  tip: error
                      .firstWhere((error) => error['title'] == "booking_type")),
            )
          ],
        ],
      ));
