...
class ProfileDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ProfileDetailController controller = Get.isRegistered<ProfileDetailController>()
        ? Get.find<ProfileDetailController>()
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: controller.profileType == "driver"
                            ? driverInfoWidget(
                                ...
                                context: context,
                                passengerDrivenLabel:
                                    "${controller.labelTextDetail['passenger_driven_label'] ?? "Passenger driven"}",
                                joinedLabel:
                            ...
                            : controller.profileType == "passenger"
                                ? passengerInfoWidget(
                                    ...
                                    context: context,
                                    yearOldLabel:
                                        "${controller.labelTextDetail['year_old_label'] ?? "years old"}",
                                    joinedLabel:
                                        "${controller.labelTextDetail['joined_label'] ?? "Joined"}",
                                    passengerName:
                                ...
                                : userInfoWidget(
                                    ...
                                    context: context,
                                    editProfileLabel:
                                        "${controller.labelTextDetail['edit_profile_text'] ?? "Edit profile"}",
                                    imagePath:
                      ...
                      Container(
                          ...
                          child: txt25Size(
                              title:
                                  "${controller.labelTextDetail['min_bio_label'] ?? "Mini bio"}",
                              textColor: textColor,
                              fontFamily: regular,
                              context: context)),
                      miniBioWidget(
                      ...
                      if (controller.profileType == "driver" &&
                        ...
                        userPassengerDrivenWidget(
                            ...
                            kmSharedLabel:
                                "${controller.labelTextDetail['km_shared_label'] ?? "KM shared"}",
                            passengerDrivenLabel:
                                "${controller.labelTextDetail['passenger_driven_label'] ?? "Passenger driven"}",
                            ridesTakenLabel:
                                "${controller.labelTextDetail['rides_taken_label'] ?? "Rides taken"}",
                            context: context),
                        10.heightBox,
                      ],
                      ...
                      // Reviews section - only show for driver and passenger profiles, not user
                      if (controller.profileType != "user") ...[
                        Container(
                          padding: EdgeInsets.only(
                              left: getValueForScreenType<double>(
                                  ...
                                  child: reviewCard(
                                    ...
                                    image: controller.reviews[index]['from']
                                        ...
                                        (controller.reviews[index]['from']
                                            ...
                                            ? defaultFemaleImage
                                            : defaultMaleImage),
                                    addedOn: controller.reviews[index]
                                        ['added_on'],
                                    rating: controller.reviews[index]
                                                ['average_rating'] !=
                                            null
                                        ? double.parse(controller.reviews[index]
                                            ['average_rating'])
                                        : 0.0,
                            ...
                            child: Align(
                              ...
                              child: InkWell(
                                  ...
                                  child: textWithUnderLine(
                                      title:
                                          "${controller.labelTextDetail['link_review_label'] ?? "View all reviews"}",
                                      textSize: 22,
