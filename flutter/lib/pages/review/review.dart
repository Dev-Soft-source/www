  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Obx(
            () => secondAppBarWidget(
                title: Get.parameters['type'] == "user"
                    ...
                    : Get.parameters['type'] == "driver" ||
                            Get.parameters['type'] == "passenger"
                    ...
                    controller.reviews.isNotEmpty
                        ? ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return InkWell(
                                onTap: () {
                                  Get.toNamed(
                                      '/review_detail/${controller.reviews[index]['id']}/to/passenger');
                                },
                                child: reviewCard(
                        ...
                        : Center(
                            child: txt20Size(
                                context: context,
                                title:
                                    "${controller.labelTextDetail['no_more_data_label'] ?? "No More data to show"}"),
                          ),
                    10.heightBox,
