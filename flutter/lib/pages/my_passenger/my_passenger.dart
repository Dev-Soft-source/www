            ...
            return Container(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    var dateTimeString =
                        "${controller.myPassengers[index]['ride']['date']} ${controller.myPassengers[index]['ride']['time']}";
                        ...
                        widgetChild: Column(
                          ...
                          children: [
                            headerWidget(
                                context: context,
                                name:
                                    "${controller.myPassengers[index]['passenger'] != null ? controller.myPassengers[index]['passenger']['first_name'] : ""}",
                                screenWidth: context.screenWidth,
                                age:
                                    "${controller.myPassengers[index]['passenger'] != null ? controller.myPassengers[index]['passenger']['age'] : ""}",
                                gender:
                                    "${controller.myPassengers[index]['passenger'] != null ? controller.myPassengers[index]['passenger']['gender_label'] : ""}",
                                image:
                                    "${controller.myPassengers[index]['passenger'] != null ? controller.myPassengers[index]['passenger']['profile_image'] : ""}",
                                controller: controller,
                                onTap: () {
                                  Get.toNamed(
                                      '/profile_detail/passenger/${controller.myPassengers[index]['passenger'] != null ? controller.myPassengers[index]['passenger']['id'] : "0"}/0');
                                }),
                            10.heightBox,
                            seatBookedRowWidget(
                                title:
                                    "${controller.labelTextDetail['seat_booked_label'] ?? "Seat booked"}",
                                value:
                              ...
                              child: SizedBox(
                                ...
                                child: elevatedButtonWidget(
                                    ...
                                    textWidget: txt22Size(
                                        context: context,
                                        title:
                                            "${controller.labelTextDetail['chat_passenger_btn_label'] ?? "Chat with passenger"}",
                                        textColor: Colors.white),
                                    onPressed: () {
                                      Get.toNamed(
                                          '/messaging_page/${controller.myPassengers[index]['user_id']}/${controller.myPassengers[index]['ride_id']}/new');
                                    }),
                              ),
                            ),
                                ...
                                child: SizedBox(
                                  ...
                                  child: elevatedButtonWidget(
                                      ...
                                      textWidget: txt22Size(
                                          context: context,
                                          title:
                                              "${controller.labelTextDetail['remove_ride_btn_label'] ?? "Remove from this ride"}",
                                          textColor: Colors.white),
                                      onPressed: () {
                                        Get.toNamed(
                                            "/remove_passenger/${controller.myPassengers[index]['id']}");
                                      },
                                      btnColor: Colors.red),
                                ),
                              ),
                                ...
                                child: SizedBox(
                                  ...
                                  child: elevatedButtonWidget(
                                      ...
                                      textWidget: txt22Size(
                                          context: context,
                                          title:
                                              "${controller.labelTextDetail['no_show_passenger_label'] ?? "No show passenger"}",
                                          textColor: Colors.white),
                                      onPressed: () async {
                                        await controller.noShowDriverData(
                                            '${controller.myPassengers[index]['id']}',
                                            '${controller.myPassengers[index]['ride']['id']}',
                                            '${controller.myPassengers[index]['user_id']}');
                                      },
                                      btnColor: Colors.red),
                                ),
                              ),
