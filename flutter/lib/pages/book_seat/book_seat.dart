                              ...
                              child: InkWell(
                                onTap: () async {
                                  controller.agreeTerms.value =
                                      controller.agreeTerms.value == true
                                          ? false
                                          : true;
                                  if (controller.agreeTerms.value == true) {
                                    controller.errors.remove(controller.errors
                              ...
                              SizedBox(
                                ...
                                child: checkBoxWidget(
                                  ...
                                  onChanged: (value) {
                                    ...
                                    if (controller.firmAgreeTerms.value ==
                                        true) {
                                      controller.errors.remove(controller.errors
                                          .firstWhereOrNull((element) =>
                                              element['title'] ==
                              ...
                              SizedBox(
                                ...
                                child: checkBoxWidget(
                                  ...
                                  onChanged: (value) {
                                    ...
                                    if (controller.pinkAgreeTerms.value ==
                                        true) {
                                      controller.errors.remove(controller.errors
                                          .firstWhereOrNull((element) =>
                                              element['title'] ==
                                ...
                                child: checkBoxWidget(
                                  ...
                                  onChanged: (value) {
                                    controller.extraCareAgreeTerms.value =
                                        value!;
                                    if (controller.extraCareAgreeTerms.value ==
                                        true) {
                                      controller.errors.remove(controller.errors
                                          .firstWhereOrNull((element) =>
                                              element['title'] ==
                            ...
                            child: SizedBox(
                              ...
                              child: elevatedButtonWidget(
                                textWidget: txt22Size(
                                    title:
                                        "${controller.labelTextDetail['book_seat_button_label'] ?? "Book seat(s)"}",
                                    fontFamily: regular,
