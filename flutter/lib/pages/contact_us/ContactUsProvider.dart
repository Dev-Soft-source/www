...
class ContactUsProvider extends GetConnect {
  ...
  Future storeContactUs(name, email, message, phone, token) async {
    try {
      ...
      final response =
          await getConnect.post("$baseUrl/$sendContactUs", data, headers: {
      ...
      logger.error("HTTP error in storeContactUs: $e");
      return Future.error({
        "type": "server",
        "message": "Server error occurred. Please try again later."
      });
    } catch (exception) {
      logger.error("Unknown error in storeContactUs: $exception");
