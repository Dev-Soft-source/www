...
class ForgetPasswordProvider extends GetConnect {
  ...
  Future forgetPassword(email) async {
    try {
      ...
      final response =
          await getConnect.post("$baseUrl/$forgotPassword", data, headers: {
      ...
      logger.error("HTTP error in forgetPassword: $e");
      return Future.error({
        "type": "server",
        "message": "Server error occurred. Please try again later."
      });
    } catch (exception) {
      logger.error("Unknown error in forgetPassword: $exception");
