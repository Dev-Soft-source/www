                ...
                @if (!empty($vehicles) && count($vehicles) > 0)
                    @foreach ($vehicles as $vehicle)
                        <div class="evem:bg-white odd:bg-gray-100 rounded border border-gray-100 shadow-md p-3 md:p-6 mt-3">
                            <div>
                                <div
                                    class='flex flex-col sm:flex-col md:flex-row lg:flex-row md:items-center justify-between space-x-2 md:space-x-4'>
                                    <div class="flex items-start space-x-4 w-full">
                                        <div
                                            class="w-20 md:w-28 h-20 md:h-28 bg-gray-50 border rounded-full overflow-hidden">
                                        ...
                                        <div class="w-[70%]">
                                            ...
                                            @php
                                                if ($vehicle->power_type == 'Gas') {
                                                    $power_type = $myVehiclePage->gas_checkbox_label;
                                                } elseif ($vehicle->power_type == 'Hybrid') {
                                    ...
                                    <div class="flex mt-4 md:mt-0 md:justify-end items-center gap-2">
                                        ...
                                        <button type="button"
                                            onclick="toggleModalCard('card-modal', {{ $vehicle->id }}, '{{ $selectedLanguage->abbreviation }}')"
                    ...
                    <div class="text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div class="mt-2 w-full">
                            <p class="can-exp-p text-center">
                                {{ $myVehiclePage->delete_vehicle_message ?? 'Are you sure you want to remove this vehicle?' }}
                            </p>
                        </div>
                    </div>
                </div>
