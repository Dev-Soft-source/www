...
@section('content')
                            ...
                            <label for="dropzone-file" id="dropzone-file-label"
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6 p-4">
                                    @if (session('uploaded_image'))
                                        <img id="profile-image" class="w-40 h-40 object-contain mb-2 cursor-pointer"
                                            src="{{ asset('driver_liscenses/' . session('uploaded_image')) }}"
                                            alt="Uploaded Image">
                                    @elseif ($user->driver_liscense)
                                        <img id="profile-image" class="w-40 h-40 object-contain mb-2 cursor-pointer"
                                            src="{{ $user->driver_liscense }}" alt="Uploaded Image">
                                    @else
                                        <img id="profile-image" class="w-16 h-16 object-contain mb-1"
                        ...
                        <div id="hide-buttons" class="hidden justify-center gap-2 mt-3">
                            <label for="edit-file"
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <input id="edit-file" name="existing_image" type="file"
    ...
    <div id="deleteConfirmationModal" class="hidden fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity z-50"
            ...
            <div class="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0 w-full">
                <div
                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="text-center w-full">
                            ...
                            <p class="text-gray-700 text-left">
                                ...
                                @else
                                    If you delete your license, you will no longer be able to post new rides, and your current
                                    active rides may be hidden or canceled. You will need to upload a valid license again to
                                    resume posting.
                                @endisset
                            </p>
                        </div>
                    ...
                    <div class="px-4 pb-6 pt-4 sm:flex sm:flex-row-reverse sm:px-6 justify-center gap-3">
                        <button type="button" onclick="confirmDeleteLicense()"
    ...
    <div id="licenseDeletedModal" class="hidden fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity z-50"
        aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0 w-full">
                <div
                    ...
                    <button type="button" onclick="closeLicenseDeletedModal()"
                        class="absolute top-3 right-3 text-gray-400 hover:text-gray-500">
                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M6 18L18 6M6 6l12 12"></path>
                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="text-center w-full">
                            ...
                            <p class="text-gray-700 text-left">
                                ...
                                @else
                                    Your driver's license has been removed. Please note that you will not be able to post any
                                    rides until a new valid license is uploaded and verified.
                                @endisset
                            </p>
                        </div>
                    </div>
