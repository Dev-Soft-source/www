...
<div class="w-full col-span-12 md:col-span-9 container mx-auto px-4 md:px-8 xl:px-0 my-14">
    <div class="flex items-center space-x-2">
        <h1 class="mb-0">
            @isset($passengerPage->main_heading)
                {{ $passengerPage->main_heading }}
            @endisset
        </h1>
    </div>
        ...
        <div class="col-span-12 lg:col-span-7">
            <div class="text-justify">
                <p class="text-lg text-gray-900">
                    @isset($passengerPage->sub_heading)
                        {{ $passengerPage->sub_heading }}
                    @endisset
                </p>
                <div class="">
                    @isset($passengerPage->page_description)
                        {!! $passengerPage->page_description !!}
                    @endisset
                </div>
            </div>
        </div>
