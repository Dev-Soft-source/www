                                                            ...
                                                            <div class="col-span-3">
                                                                <div class="flex flex-row items-center flex-wrap gap-2">
                                                                    <p class="flex items-center space-x-2 font-semibold">
                                                                        {{ $departureDateLabel }}
                                                                        {{ optional($rideDetailPage)->card_section_at_label ?? optional($rideDetailPage)->at_label ?? 'at' }}
                                                                ...
                                                                <div class="relative mt-5 text-left">
                                                                    <div class="items-center relative">
                                                                        ...
                                                                        <div class="ml-12 md:ml-20">
                                                                            <h4 class="flex gap-2 items-baseline text-xl text-black">
                                                                                {{ optional($rideDetailPage)->card_section_from_label ?? 'From' }}
                                                                            ...
                                                                            <div class="flex gap-2 items-baseline">
                                                                                ...
                                                                                <label class="text-black">
                                                                                    {{ optional($rideDetailPage)->pickup_at_label ?? 'Pick-up at' }}:
                                                                                </label>
                                                                                <p class="">
                                                                                    {{ $booking->ride->pickup }}
                                                                                </p>
                                                                    ...
                                                                    <div class="flex items-center relative">
                                                                        ...
                                                                        <div class="ml-12 md:ml-20 items-baseline">
                                                                            <h4 class="flex gap-2 items-baseline text-xl text-black">
                                                                                {{ optional($rideDetailPage)->card_section_to_label ?? 'To' }}
                                                                            </h4>
                                                                            <div class="flex gap-2 items-baseline">
                                                                                <h3
                                                                                    class="text-primary font-FuturaMdCnBT text-xl md:text-2xl md:mb-4">
                                                                                ...
                                                                                <label class="text-black">
                                                                                    {{ optional($rideDetailPage)->dropoff_at_label ?? 'Drop-off at' }}:
                                                                                </label>
                                                                                <p class="">
                                                            ...
                                                            <div class="col-span-2 px-4">
                                                                <div class="grid justify-end mt-4">
                                                                    <div class="flex items-center justify-end gap-2 mb-2">
                                                                        <p class="font-medium text-red-500 bg-red-100 px-2 rounded">
                                                                            Cancelled
                                                                        </p>
                                                                    </div>
                                                                    <div class="pr-8">
                                                                        <p class="font-medium">
                                                                            {{ str_replace(':count', $booking->ride->seats, optional($rideDetailPage)->total_seats_label ?? 'Total :count seats') }}
                                                                        </p>
                                                                    </div>
                                                                    <p class="text-xl font-semibold text-primary">
                                                                        ${{ number_format(floatval($booking->price / 100), 2) }}
                                                                        <small>
                                                                            {{ optional($rideDetailPage)->card_section_per_seat ?? '' }}
                                                                        </small>
                                                                    </p>
                                                                </div>
                                                            </div>
