                        ...
                        <div class="bg-white rounded-lg overflow-hidden shadow-3xl">
                            <div class="bg-white p-4">
                                <div class="space-y-4 mb-4">
                                    <div class="mt-2 relative space-y-2">
                                        <div class="flex items-center mt-1">
                                            <label for="removed_permanently" class="flex text-sm text-gray-900">
                                                <input id="removed_permanently" name="removed_permanently" type="radio"
                                                    value="0" checked
                                        ...
                                        <div class="flex items-center mt-1">
                                            <label for="removed_permanently" class="flex text-sm text-gray-900">
                                                <input id="removed_permanently" name="removed_permanently" type="radio"
                                                    value="1" {{ old('removed_permanently') == '1' ? 'checked' : '' }}
                                                    class="mr-2 h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-600">
                                    ...
                                    <div class="text-base md:text-lg"><span class="text-red-500">* All fields are
                                            required</span></div>
                                    ...
                                    <div class="bg-white p-4 justify-center hidden showRemoveTypeButton">
                                        <ul class="grid w-full gap-6 md:grid-cols-2">
                                            <li>
                                                <input type="radio" id="temporarily" name="remove_type"
                                                    value="temporarily"
                                                    {{ old('remove_type') == 'temporarily' ? 'checked' : '' }}
                                                    class="hidden peer">
                                                <label for="temporarily"
                                            ...
                                            <li>
                                                <input type="radio" id="permanently" name="remove_type"
                                                    value="permanently"
                                                    {{ old('remove_type') == 'permanently' ? 'checked' : '' }}
                                                    class="hidden peer">
                                                <label for="permanently"
                                                    class="inline-flex items-center space-x-3 w-full p-4 text-gray-800 bg-white border-2 border-gray-100 rounded cursor-pointer peer-checked:border-green-500 peer-checked:border-2 peer-checked:text-green-500 hover:border-2 hover:border-green-500">
                                    ...
                                    <div id="block_days" class="hidden justify-between w-full max-w-md  items-center">
                                        <label for="block_day"
                                            class="text-gray-900 font-medium text-lg lg:text-xl mb-2 w-full">{{ $tripsPage->remove_day_label ?? 'How many seats do you want to cancel?' }}
                                            :</label>
                                        <div>
                                            <input type="number" step="1" min="1" id="block_day"
                                                placeholder="{{ $tripsPage->remove_day_placeholder ?? 'Select' }}"
                                                name="block_day"
                                    ...
                                    <div class="mt-6 w-full">
                                        <label for="meeting"
                                            class="text-gray-900 font-medium text-lg mb-2">{{ $tripsPage->driver_remove_reason_label ?? 'Tell us why' }}</label>
                                    ...
                                    <div class="mt-6">
                                        <label for="meeting"
                                            class="text-gray-900 font-medium text-lg mb-2">{{ $tripsPage->passenger_remove_reason_label ?? 'Tell your passenger why' }}</label>
                    ...
                    <div
                            ...
                            <div class="text-center sm:ml-4 sm:mt-0 sm:text-left">
                                ...
                                <div class="mt-2 w-full">
                                    <p class="text-lg text-center text-black">
                                        {{ $tripsPage->passenger_cancel_sure_message ?? 'Are you sure you want to delete this passenger?' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="px-4 pb-6 pt-4 flex items-center space-x-2 sm:space-x-4 sm:px-6 justify-center">
                            ...
                            <button type="button" onclick="toggleModalCard('card-modal')"
                                class="button-exp-fill sm:w-24">{{ $successMessage->popup_close_btn_text ?? 'Close' }}</button>
                        </div>
                    </div>
                </div>
            </div>
