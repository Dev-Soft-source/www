                ...
                <div>
                    <div class="flex items-center space-x-2">
                        <div class="w-16 h-16 md:w-24 md:h-24 bg-gray-50 border rounded-full overflow-hidden">
                            <img class="w-full h-full object-contain rounded-full" src="{{ $booking->passenger->profile_image }}" alt="">
                        </div>
                        <p class="text-black text-2xl lg:text-3xl font-FuturaMdCnBT">{{ $booking->passenger->first_name }}</p>
                    </div>
                    <div class="mt-6">
