        ...
        <div class="bg-white border rounded p-4 border-gray-200 w-full col-span-12 lg:col-span-9 shadow">
            <div class="mt-4 pb-2">
                ...
                <p>
                    ...
                    @else
                        You can update your password from here. Your password must be at least 8 characters long, including
                        a lowercase letter, an uppercase letter, a number, and a special character. Strong passwords include
            ...
            <form method="POST" action="{{ route('password.update', auth()->user()->id) }}">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 w-full md:w-1/2 gap-4 mt-4">
                    <div>
                        <label
                            for="">{{ $passwordSettingPage->current_password_label ?? 'Current password' }}</label>
                    ...
                    <div class="">
                        <label
                            for="">{{ $passwordSettingPage->confirm_new_password_label ?? 'Confirm new password' }}</label>
                        <div class="mt-2 relative">
                            <input id="password3" type="password" name="pass3"
                                class="font-FuturaMdCnBT block mt-1 border p-1.5 w-full rounded text-base md:text-lg border-gray-300 focus:ring-none focus:outline-none focus:border-blue-600">
