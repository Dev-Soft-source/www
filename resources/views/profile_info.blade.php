      ...
      <div class=" px-4">
        ...
        <div class="flex pb-2 justify-between">
            <div class="flex items-start">
                <img class="w-16 h-16 rounded-full object-cover mr-3 mt-2" src="{{ $user->profile_image }}" alt="">
                @php
        ...
        <div class="bg-blue-50 p-4 flex justify-center my-4 px-4">
            <div class="w-full md:w-3/4 flex justify-center items-center">
                ...
                <div class="flex flex-col justify-center items-center w-48 my-4">
                    ...
                    <p class="text-xl font-semibold">
                        {{ number_format($user->getTakenDistanceByDriver(), 2) }}
                    </p>
        ...
        <div class="pb-2 px-4">
            <h3 class="mb-0text-2xl xl:text-3xl">{{ $ratings->count() }} Reviews</h3>
