                                                    ...
                                                    <div class="border rounded-md overflow-hidden divide-y">
                                                        @php
                                                            ...
                                                            foreach ($cards as $card) {
                                                                if($card->payment_method_type == 'card') $on_card = true;
                                                                elseif($card->payment_method_type == 'paypal') $on_paypal = true;
                                                                elseif($card->payment_method_type == 'google_pay') $on_google_pay = true;
                                                                elseif($card->payment_method_type == 'apple_pay') $on_apple_pay = true;
                                                            }
                                                        @endphp
                                                        @if(!$on_paypal)
                                                        <div class="flex items-center justify-between p-3">
                                                            <label for="paypal"
                                                                ...
                                                                <img class="h-8"
                                                                    src="{{ asset('assets/paypal_img.png') }}"
                                                                    alt="">
                                                        ...
                                                        <div class="flex items-center justify-between p-3 google-pay-option">
                                                            <label for="google_pay"
                                                                ...
                                                                <img class="h-8"
                                                                    src="{{ asset('assets/google_pay_img.png') }}"
                                                                    alt="">
                                                                    <div class="absolute top-2 right-3 ">
                                                                        <input type="radio"
                                                                            id="google_pay"
                                                        ...
                                                        <div class="flex items-center justify-between p-3 apple-pay-option">
                                                            <label for="apple_pay"
                                                                ...
                                                                <img class="h-8"
                                                                    src="{{ asset('assets/apple_pay_img.png') }}"
                                                                    alt="">
                                                                    <div class="absolute top-2 right-3 ">
                                                                        <input type="radio"
                                                                            id="apple_pay"
                                                        ...
                                                        <div class="p-3">
                                                            <label for="credit_card"
                                                                ...
                                                                <svg class="h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M3.92969 15.8792L15.8797 3.9292" stroke="#2563ea" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M11.1013 18.2791L12.3013 17.0791" stroke="#2563ea" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M13.793 15.5887L16.183 13.1987" stroke="#2563ea" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M3.60127 10.239L10.2413 3.599C12.3613 1.479 13.4213 1.469 15.5213 3.569L20.4313 8.479C22.5313 10.579 22.5213 11.639 20.4013 13.759L13.7613 20.399C11.6413 22.519 10.5813 22.529 8.48127 20.429L3.57127 15.519C1.47127 13.419 1.47127 12.369 3.60127 10.239Z" stroke="#2563ea" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M2 21.9985H22" stroke="#2563ea" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>    
                                                                    ...
                                                                    <label 
                                                                        ...
                                                                        <div class="flex items-center space-x-3">
                                                                            @if ($card->payment_method_type == 'card' && $card->paymentMethod && $card->paymentMethod->card)
                                                                                ...
                                                                                @if ($brand === 'visa')
                                                                                    <div
                                                                                        class="w-14 h-9 flex items-center justify-center">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                                            ...
                                                                                            <g
                                                                                                clip-path="url(#clip0_4934_35103)">
                                                                                                <path fill="#00579f"
                                                                                ...
                                                                                @elseif($brand === 'mastercard')
                                                                                    <div
                                                                                        class="w-14 h-9 flex items-center justify-center p-1">
                                                                                ...
                                                                                @elseif($brand === 'amex' || $brand === 'american express')
                                                                                    <div
                                                                                        ...
                                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                                            ...
                                                                                            class="p-Logo p-Logo--md p-CardBrandIcon">
                                                                                            <g
                                                                                                clip-path="url(#clip0_4934_35113)">
                                                                                                <path fill="#0193ce"
                                                                                                    d="M22 0H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2">
                                                                                                </path>
                                                                                                <path fill="#fff"
                                                                            ...
                                                                            @elseif($card->payment_method_type == 'google_pay')
                                                                                <div class="flex items-center space-x-3">
                                                                                    <div
                                                                                        ...
                                                                                        <svg class="gpay-logo"
                                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                                            width="243.67" height="95.6"
                                                                                            viewBox="0 0 243.67 95.6">
                                                                                            <g id="G_Pay_Lockup"
                                                                                                data-name="G Pay Lockup">
                                                                                                <g id="Pay_Typeface"
                                                                                                    data-name="Pay Typeface">
                                                                                                    <path id="Letter_p"
                                                                                                        data-name="Letter p"
                                                                                                        ...
                                                                                                        transform="translate(-262.17 -336.2)"
                                                                                                        style="fill:#eeeeee" />
                                                                                                    <path id="Letter_a"
                                                                                                        data-name="Letter a"
                                                                            ...
                                                                            @elseif($card->payment_method_type == 'paypal')
                                                                                <div class="flex items-center space-x-3">
                                                                                    <div
                                                                                        class="w-12 h-8 flex items-center justify-center p-1">
                                                                                        <svg id="uuid-b27e1cd4-82a8-41c1-8e0b-cc5053329b51"
                                                                                            ...
                                                                                            <defs>
                                                                                                <clipPath
                                                                                                    id="uuid-a44e4e19-5cfa-4d0b-904a-d3baa99153ff">
                                                                                                    <rect width="37.35"
                                                                                                        height="45"
                                                                                                        style="fill:none;" />
                                                                                                </clipPath>
                                                                                            ...
                                                                                            <g
                                                                                                style="clip-path:url(#uuid-a44e4e19-5cfa-4d0b-904a-d3baa99153ff);">
                                                                                                <path
    ...
    <script>
        $(document).ready(function() {
            ...
            function toggleInlineCardSection() {
                const selected = $('input[type=radio][name=card_id]:checked').get(0);
                const isCreditCardSelected = selected && selected.id === 'credit_card';
                const $creditCardDiv = $('#credit-card-div');
