  ...
  <div id="ridesharing_app" class="relative z-50" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
      <div class="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0 w-full">
        <div class="animate__animated animate__fadeIn relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl">
          <div class="bg-white w-full">
            <div class="">
              <div class="text-center sm:text-left">
                <div class="flex items-center justify-between w-full border-b px-4 py-2 bg-primary text-white">
                    <h1 class="mb-0 text-white" id="modal-title">1 {{ $chatsPage->driver_chat_with ?? 'Chat with' }} {{ $passenger->first_name }}</h1>
                     <a href="{{ route('notifications', ['lang' => app()->getLocale()]) }}" class="h-fit block text-100 bg-transparent rounded-full border border-gray-100 text-sm p-1 ml-auto">
                        <svg aria-hidden="true" class="w-3 h-3 text-gray-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
