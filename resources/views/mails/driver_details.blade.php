            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">Thank you for using ProximaRide. Here are your booking details: </p>
                        <p style="font-weight: 700;color: #000;">Driver details: </p>
                        <p style="font-weight: 400;color: #000;">Driver name: {{ $data['driver_first_name'] }}</p>
                        <p style="font-weight: 400;color: #000;">Driver phone number: {{ $data['phone'] }}</p>
                        <p style="font-weight: 400;color: #000;">Driver email: {{ $data['email'] }}</p>
                        ...
                        <p style="font-weight: 400;color: #000;">Contact your driver before the ride to get full information, and be at the pick-up location 10 minutes early. If your driver is not there on time, call them, and gather as much detail and evidence as possible BEFORE leaving the meeting place. ProximaRide releases the payment to the driver only after the ride is complete.</p>
                    </td>
                </tr>
                <tr>
                    <th>
