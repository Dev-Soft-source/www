            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">You have a new message from {{ $data['driver_name'] }} with their reasons for cancelling this ride. Log in to read it.</p>
                        ...
                        {{-- <p style="font-weight: 700;color: #000;">Cancellation reason:</p>
                        <p style="font-weight: 400;color: #000;">{{ $data['cancellation_reason'] }}</p> --}}

                        {{-- <p style="font-weight: 400;color: #000;">All amounts that you have made for this booking will be refunded to you immediately.</p>
                        <p style="font-weight: 400;color: #000;">Do not be discouraged; go ahead and search for other trips on ProximaRide.</p> --}}
                    </td>
                </tr>
                <tr>
                    <th>
                        <p style="color: #000; font-weight: 400;margin-top:12px;margin-bottom: 0;">Once again, we apologise for the inconvenience and wish you a safe ride</p>
