            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">Your driver {{ $data['driver_first_name'] }} has updated details in his ride</p>
                        <p style="font-weight: 400;color: #000;">The updated details are:</p>
                        <p style="font-weight: 400;color: #000;">From: {{ $data['from'] }}</p>
                        <p style="font-weight: 400;color: #000;">To: {{ $data['to'] }}</p>
                        <p style="font-weight: 400;color: #000;">Date: {{ $data['date'] }}</p>
                        <p style="font-weight: 400;color: #000;">Time: {{ \Carbon\Carbon::parse($data['time'])->format('h:i A') }}</p>
                        <p style="font-weight: 400;color: #000;">Prize: ${{ $data['price'] }} per seat</p>
