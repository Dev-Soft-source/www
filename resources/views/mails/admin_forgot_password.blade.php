        ...
        <tr>
          <td style="width: 600px; max-width: 100%;background:#fff; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        <p style="font-weight: 500;color: #000;">We have recieved a request to reset your password for your Proximaride account. To proceed with the password reset process, please follow the instructions below:</p>
                        <p style="font-weight: 400;color: #000;">Click on the following link to reset your password:</p>
                        <p style="text-align: center; margin: 38px 0;">
                            <a style="border-radius: 4px; background-color: #2563eb; padding: 12px 24px; font-size: 16px; font-weight: bold; color: #ffffff; text-decoration: none; display: inline-block; margin: 0 auto;" href="{{ route('password.reset', ['token' => $data['token']]) }}"
                                target="_blank">Reset My Password</a>
                        </p>
                        <p style="font-weight: 400;color: #000;"><span style="font-weight: 500;">Note:</span> If you are unable to click on the link, please copy and paste it in your web browser's address bar. <a
                                href="{{ route('password.reset', ['token' => $data['token']]) }}"
                                target="_blank">{{ env('APP_URL') }}/admin/reset-password/{{ $data['token'] }}</a>
                        </p>
                        <p style="font-weight: 400;color: #000;">You will be redirected to a page where you can enter a new password.</p>
                        <p style="font-weight: 400;color: #000;"><span style="font-weight: 500;">Note:</span> For security purposes, we recommend choosing a strong password that contains a combination of letters, numbers and special characters.</p>
                        <p style="font-weight: 400;color: #000;">If you did not initiate this password reset request, please ignore this email. Your account will remain secure.</p>
                    </td>
                </tr>
                <tr>
                    <th>
