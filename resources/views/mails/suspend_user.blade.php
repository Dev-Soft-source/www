            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">Your account on ProximaRide has been temporarily suspended. Please log in as soon as possible to see the reason(s) and address them</p>
                    </td>
                </tr>
                <tr>
                    <th>
