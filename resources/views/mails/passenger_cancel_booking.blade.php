        ...
        <tr>
          <td style="width: 600px; max-width: 100%;background:#fff; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        <h1 style="font-weight: 700;color: #000;">{{ $greeting_message ?? 'Hi' }} {{ $data['driver_name'] }},</h1>
                        <p style="font-weight: 400;color: #000;">Seat(s) have been cancelled on your ride: </p>
                        ...
                        <p style="font-weight: 400;color: #000;"><b>Booking / cancellation details:</b></p>
                        <p style="font-weight: 400;color: #000;">Passenger name: {{ $data['passenger_name'] }}</p>
                        <p style="font-weight: 400;color: #000;">Seats booked: {{ $data['seats'] }}</p>
                        <p style="font-weight: 400;color: #000;">Seats cancelled: {{ $data['cancelled_searts'] }}</p>
                        <p style="font-weight: 400;color: #000;">Seats remaining: {{ $data['seats'] - $data['cancelled_searts'] }}</p>
                        <p style="font-weight: 400;color: #000;">Amount due to you: ${{ $data['cancelled_searts'] * $data['price'] }} (* See our cancellation policy)</p>
                        <p style="font-weight: 400;color: #000;">We have taken the liberty of opening the cancelled seat(s) for other passengers to book </p>
                    </td>
                </tr>
                <tr>
                    <th>
                                ...
                                <td align="center" style="display: flex;">
                                    <div style="display: inline-flex; flex-wrap: wrap; justify-content: center;">
                                        ...
                                        <a aria-label="ProximaRide" target="_blank" href="https://www.linkedin.com"
                                            style="border: 1px solid #d1d5db; display: inline-flex; align-items: center; justify-content: center; height: 40px; width: 40px; border-radius: 50%; background-color: #fffffe;">
