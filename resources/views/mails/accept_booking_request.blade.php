        ...
        <tr>
          <td style="width: 600px; max-width: 100%;background:#fff; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        <h1 style="font-weight: 700;color: #000;">{{ $greeting_message ?? 'Hi' }} {{ $data['driver_first_name'] }},</h1>
                        <p style="font-weight: 400;color: #000;">Here are the details of the booking you just approved on ProximaRide. </p>
                        <p style="font-weight: 700;color: #000;">Booking details: </p>
                        <p style="font-weight: 400;color: #000;">Passenger name: {{ $data['first_name'] }}</p>
