...
<body style="margin: 0; width: 100%; background-color: #fff; padding: 0; -webkit-font-smoothing: antialiased; word-break: break-word;">
  <div role="article" aria-roledescription="email" aria-label="Account Closure Email" lang="en">
            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">This is an automated email to acknowledge the closure of your account and receipt of your message. If you asked for a response, we will respond to you within two business days.</p>
                        <p style="font-weight: 400;color: #000;">Note: If you believe this email has reached you in error, please contact us as soon as possible</p>
                    </td>
                </tr>
                <tr>
                    <th>
                        <p style="color: #000; font-weight: 400;margin-top:12px;margin-bottom: 0;">Once again, we wish you all the best</p>
