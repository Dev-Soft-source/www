        ...
        <tr>
          <td style="width: 600px; max-width: 100%;background:#fff; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        <h1 style="font-weight: 700;color: #000;">{{ $greeting_message ?? 'Hi' }} {{ $data['passenger_name'] }},</h1>
                        <p style="font-weight: 400;color: #000;">We are sorry to inform you that the driver has cancelled this ride. They will send you a separate message explaining their reasons.</p>
                        <p style="font-weight: 400;color: #000;">While we pride ProximaRide on being a RELIABLE platform, we never know what life can throw at us. We assure you that we conduct a thorough investigation on each cancellation and, in case of frequent cancellations, we block the driver’s account </p>
                        ...
                        <p style="font-weight: 700;color: #000;">Your booking details:</p>
                        ...
                        <p style="font-weight: 400;color: #000;">All amounts that you have made for this booking will be refunded to you immediately. </p>
                        <p style="font-weight: 400;color: #000;">
                            Do not be discouraged; go ahead and search for other trips on ProximaRide </p>
                    </td>
                </tr>
                <tr>
                    <th>
                        <p style="color: #000; font-weight: 400;margin-top:12px;margin-bottom: 0;">Please accept our sincere apologies for the inconvenience and have a safe ride</p>
