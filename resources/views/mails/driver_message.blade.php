        ...
        <tr>
          <td style="width: 600px; max-width: 100%;background:#fff; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        <h1 style="font-weight: 700;color: #000;">Good morning {{ $data['passenger_first_name'] }},</h1>
                        <p style="font-weight: 400;color: #000;">You have a new message from your driver ({{ $data['driver_first_name'] }}). Log in to read it.</p>
                        ...
                        <p style="font-weight: 400;color: #000;">It is important to respond to all your messages and answer your driver's questions in timely manner.</p>
                    </td>
                </tr>
                <tr>
                    <th>
