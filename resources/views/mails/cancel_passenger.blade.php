            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">We are sorry to inform you that the driver has cancelled your booking with them. While it is entirely and solely the driver’s right to decide whom they want to travel with, if you believe you are being discriminated against for ANY reason, let us know right away</p>
                        ...
                        <p style="font-weight: 400;color: #000;">All payments that you have made to book on this ride will be refunded to you immediately </p>
                    </td>
                </tr>
                <tr>
                    <th>
