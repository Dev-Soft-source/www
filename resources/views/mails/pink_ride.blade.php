            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">Your Pink Ride is now live on ProximaRide.</p>
                        <p style="font-weight: 700;color: #000;">Pink Ride details:</p>
                        ...
                        <p style="font-weight: 400;color: #000;"><span style="font-weight: 700">At:</span> {{ \Carbon\Carbon::parse($data['at'])->format('h:i A') }}</p>
