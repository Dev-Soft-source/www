        ...
        <tr>
          <td style="width: 600px; max-width: 100%;background:#fff; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        <h1 style="font-weight: 700;color: #000;">Hello {{ $data['first_name'] }},</h1>
                        <p style="font-weight: 400;color: #000;">Your driver license has been approved by admin. Now you can enjoy posting your first ride</p>
                    </td>
                </tr>
                <tr>
                    <th>
