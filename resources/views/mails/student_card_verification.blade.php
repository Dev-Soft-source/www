                ...
                <tr>
                    <td
                        ...
                        <table style="width: 100%;margin-bottom: 24px;" cellpadding="0" cellspacing="0" role="none">
                            <tr>
                                <td align="center"
                                    style="background:#fff;border-bottom: 3px solid black; padding: 20px 0;">
                        ...
                        <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                            <tr>
                                <td>
                                    <h1 style="font-weight: 700;color: #000;">{{ $greeting_message ?? 'Hi' }}
                                        {{ $data['username'] }},</h1>
                                    <p style="font-weight: 400;color: #000;">
                                        We are pleased to confirm that your student card has been reviewed and approved by the admin. You can now enjoy our exclusive offers to the students
                                    </p>
                            ...
                            <tr>
                                <th>
                                    {{-- <p style="color: #000; font-weight: 400;margin-top:12px;">Welcome to ProximaRide
                                        <br> {{ env('APP_NAME') }} Team</p> --}}
                                        <p style="color: #000; margin-top: 12px;">
                                            <span style="font-weight: 400;">Welcome to ProximaRide<br></span>
                                            <span style="font-weight: 700;">{{ env('APP_NAME') }} Team</span>
                                        </p>
                                </th>
                            </tr>
                            <tr>
