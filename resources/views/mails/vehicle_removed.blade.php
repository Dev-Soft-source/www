            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">A vehicle has just been removed from your ProximaRide profile. If it was you who did this, disregard this message.</p>
                        <p style="font-weight: 400;color: #000;">If not, contact us immediately from your app and email.</p>
                    </td>
                </tr>
                <tr>
                    <th>
                        {{-- <p style="color: #000; font-weight: 700;margin-top:12px;">Thank you and stay safe <br> {{ env('APP_NAME') }} Team</p> --}}
                        <p style="color: #000; margin-top: 12px;">
                            <span style="font-weight: 400;">Thank you and stay safe<br></span>
