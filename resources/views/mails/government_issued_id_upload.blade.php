            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">{{ $data['first_name'] }} {{ $data['last_name'] }} has uploaded government issued id. Please visit your dashboard to check.</p>
                        <p style="font-weight: 400;color: #000;">The member details are:</p>
