            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;text-align: center;"><a style="background-color: #2563eb; color: white; text-decoration: none; padding: 1% 2%; border-radius: 4px" href="{{ route('review_driver', ['lang' => $data['abbreviation'], 'id' => $data['uuid']]) }}"
                            target="_blank">Give us your feedback</a></p>
                    </td>
                </tr>
                <tr>
                    <th>
