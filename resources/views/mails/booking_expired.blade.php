            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">We are sorry to inform you that the driver has not responded to your booking request within the allotted time, and it has now expired. Please do not take it personally, and note that it is entirely and solely the driver's right to accept or decline the booking requests.</p>
                ...
                <tr>
                    <th>
                        <p style="color: #000; margin-top: 12px;">
                            <span style="font-weight: 400;">Thank you and have a good day<br></span>
