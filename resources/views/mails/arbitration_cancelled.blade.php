            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">The arbitration on ProximaRide regarding your trip</p>
                        ...
                        <p style="font-weight: 400;color: #000;">has been cancelled by the other party. You do not need to do anything regarding this, and it will not show on your profile </p>

                    </td>
                </tr>
                <tr>
                    <th>
                        <p style="color: #000; font-weight: 400;margin-top:12px;margin-bottom: 0;">Thank you, and drive safe</p>
