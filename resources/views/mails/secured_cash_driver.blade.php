        ...
        <tr>
          <td style="width: 600px; max-width: 100%;background:#fff; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        <h1 style="font-weight: 700;color: #000;">Hi {{ $data['driver_first_name'] }},</h1>
                        <p style="font-weight: 400;color: #000;">The Secured-cash payment code that you just entered was successful.</p>
                        <p style="font-weight: 400;color: #000;">Now, take your payment from the passenger in cash. Take the booking price only, not the booking fee.</p>
                        ...
                        <p style="font-weight: 400;color: #000;">Booking price: ${{ $data['booking_price'] }}</p>
                        ...
                        <p style="font-weight: 400;color: #000;">Passenger phone number: {{ $data['passenger_phone'] }}</p>
                        <p style="font-weight: 400;color: #000;">Passenger email: {{ $data['passenger_email'] }}</p>
                    </td>
                </tr>
                <tr>
                    <th>
