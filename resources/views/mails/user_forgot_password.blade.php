            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">We have received a request to reset your password for your ProximaRide account. To proceed with this process, please click here:</p>
                        <p style="text-align: center; margin: 38px 0;">
                            <a style="border-radius: 4px; background-color: #2563eb; padding: 12px 24px; font-size: 16px; font-weight: bold; color: #ffffff; text-decoration: none; display: inline-block; margin: 0 auto;" href="{{ route('reset.password', ['lang' => $data['lang'],'token' => $data['token']]) }}{{ isset($data['is_app']) && $data['is_app'] ? '?app=true' : '' }}"
                                target="_blank">Reset My Password</a>
                        </p>
                        <p style="font-weight: 400; color: #000;"><span style="font-weight: 500;">If your browser does not permit you to click on the link above, please copy and paste this URL into your web browser's address bar: <br>  <a
                                href="{{ route('reset.password', ['lang' => $data['lang'],'token' => $data['token']]) }}{{ isset($data['is_app']) && $data['is_app'] ? '?app=true' : '' }}"
                                target="_blank">{{ env('APP_URL') }}/reset-password/{{ $data['token'] }}{{ isset($data['is_app']) && $data['is_app'] ? '?app=true' : '' }}</a>
                        </p>
                        <p style="font-weight: 400; color: #000;">You will be redirected to a page where you can select a new password</p>
                        <p style="font-weight: 400; color: #000;">Passwords on ProximaRide must be at least 8 characters long, including a lowercase letter, an uppercase letter, a number, and a special character. </p>
                        <p style="font-weight: 400; color: #000;"><span style="font-weight: 500;">Note:</span> If you did not initiate a password reset process, please disregard this message. Your information will remain secure</p>
                    </td>
                </tr>
                <tr>
                    <th>
