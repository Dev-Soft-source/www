...
<body style="margin: 0; width: 100%; background-color: #fff; padding: 0; -webkit-font-smoothing: antialiased; word-break: break-word;">
  <div role="article" aria-roledescription="email" aria-label="Birthday Email" lang="en">
            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">On behalf of the entire ProximaRide family, we are writing to congratulate you with your birthday. Wherever the years ahead take you, we hope it's happy.</p>
                        <p style="font-weight: 400;color: #000;">Enjoy your special day, and have the best birthday ever!</p>
                        <p style="color: #000; font-weight: 700;">The Entire ProximaRide Team</p>

                          <!-- Birthday image -->
                          <div style="text-align: center; margin: 20px 0;">
                            <img src="https://i.gyazo.com/f5ae37680d22e5cbf6e5a8b130b0ed38.png" alt="Happy Birthday" style="max-width: 100%; height: auto;">
                        </div>
                    </td>
                </tr>
                <tr>
