            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">Your booking request has been approved.</p>
                        <p style="font-weight: 700;color: #000;">Diver details:</p>
                        <!-- Driver information -->
                        ...
                        <p style="font-weight: 400;color: #000;">Driver email: {{ $data['driver_email'] }}</p>
                        ...
                        <!-- Modified instructions for passenger -->
                        <p style="font-weight: 400;color: #000;">
                            Contact your driver before the ride to get full information, and be at the pick-up location 10 minutes early. If your driver is not there on time, call them, and gather as much detail and evidence as possible BEFORE leaving the meeting place. ProximaRide releases the payment to the driver only after the ride is complete.
                        </p>
                    </td>
                </tr>
                <tr>
