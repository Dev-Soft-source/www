            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">This is the receipt for your transaction on ProximaRide. We recommend you save this email or print it out for your records.</p>
                        ...
                        <table class="payment-details">
                          ...
                          <tr>
                            ...
                            <td style="color: #000;font-weight: 400;font-size: 16px;">${{ number_format($data['online_payment'], 2) }}</td>
                          </tr>
                          <tr>
                            <td style="color: #000;font-weight: 700;font-size: 16px;">Transaction ID:</td>
                            <td style="color: #000;font-weight: 400;font-size: 16px;">{{ $data['transaction_id'] ?? 'N/A' }}</td>
                          </tr>
                          <tr>
                            <td style="color: #000;font-weight: 700;font-size: 16px;">Transaction date:</td>
                            <td style="color: #000;font-weight: 400;font-size: 16px;">{{ $data['transaction_date'] ?? Carbon\Carbon::now()->format('F j, Y \a\t H:i \E\S\T') }}</td>
                          </tr>
                          {{-- <tr>
