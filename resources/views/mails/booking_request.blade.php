            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">You have a new booking request on ProximaRide.</p>
                        <!-- <p style="font-weight: 400;color: #000;">Alternatively, Click <a href="{{ route('accept_booking_request', ['lang' => $data['lang'],'id' => $data['id'],'email' => $data['email']]) }}" style="background-color: #2563eb; color: white; text-decoration: none; padding: 1%; border-radius: 4px" href=""
                                target="_blank">Approve booking</a> to approve or <a style="background-color: #2563eb; color: white; text-decoration: none; padding: 1%; border-radius: 4px" href="{{ route('reject_booking_request', ['lang' => $data['lang'],'id' => $data['id'],'email' => $data['email']]) }}"
                                target="_blank">Decline booking</a> to decline</p> -->


                        <p style="font-weight: 700;color: #000;">Ride details:</p>
                        <p style="font-weight: 400;color: #000;">From: {{ $data['from'] }}</p>
                        <p style="font-weight: 400;color: #000;">To: {{ $data['to'] }}</p>
                        ...
                        <p style="font-weight: 700;color: #000;">Booking request details:</p>

                        <p style="font-weight: 400;color: #000;">Passenger name: {{ $data['passenger_first_name'] }}</p>
                        <p style="font-weight: 400;color: #000;">Seats requested: {{ numberToWords($data['seats']) }}</p>
                        <p style="font-weight: 400;color: #000;">Booking price (total): ${{ $data['total_price'] }}</p>
                        <p style="font-weight: 400;color: #000;">Log in to ProximaRide to view their passenger profile, and approve or decline their booking. Reply quickly to maintain a high response rate. You have until {{ $data['expires_at'] ?? '' }} to respond.</p>
                    </td>
                </tr>
                <tr>
                    <th>
