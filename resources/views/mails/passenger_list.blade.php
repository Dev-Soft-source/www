        ...
        <tr>
          <td style="width: 600px; max-width: 100%;background:#fff; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        <h1 style="font-weight: 700;color: #000;">Hi {{ $data['driver_name'] }},</h1>
                        <p style="font-weight: 400;color: #000;">Here is your passenger list for the ride:</p>
                        ...
                        <p style="font-weight: 700;color: #000; margin-top: 20px;">Your passengers are:</p>

                        @foreach($data['passengers'] as $index => $passenger)
                        <p style="font-weight: 400;color: #000;">
                            {{ $index + 1 }}- Passenger name: {{ $passenger['first_name'] }}<br>
                            Seats booked: {{ numberToWords($passenger['seats']) }}
                        </p>
                        @endforeach

                        <p style="font-weight: 400;color: #000; margin-top: 20px;">
                            Contact your passengers before the ride to explain everything to them, and be at the pick-up location 10 minutes early. If a passenger does not show up on time, call them, and gather as much detail and evidence as possible BEFORE departing.
                        </p>
                    </td>
                </tr>
                <tr>
                    <th>
                        <p style="color: #000; margin-top: 12px;">
                            <span style="font-weight: 400;">Thank you and have a safe ride<br></span>
