                        ...
                        <div style="display: flex; margin: 20px auto;">
                            <a href="">
                                <img src="{{ asset('assets/PROXIMARIDE.png') }}" alt="ProximaRide"
                                    style="height: 100px; vertical-align: middle; max-height: 100px">
                            </a>
                        </div>
                    </td>
                </tr>
            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">Thanks for joining ProximaRide, and welcome!</p>
                        <p style="font-weight: 400;color: #000;">Keeping your account secure is important to us. As a
                            security measure, please click on this link to verify your email address:</p>
                        <p style="text-align: center; margin: 38px 0;">
                            <a style="border-radius: 4px; background-color: #2563eb; padding: 12px 24px; font-size: 16px; font-weight: bold; color: #ffffff; text-decoration: none; display: inline-block; margin: 0 auto;"
                                href="{{ route('emailVerify', ['token' => $data['token'], 'email' => $data['email']]) }}{{ $data['app'] ?? false ? '?app=true' : '' }}"
                                target="_blank">Verify My Email</a>
                        </p>
                        <p style="font-weight: 400;color: #000; margin-bottom: 38px;">If your browser does not permit you to click the link
                            above, copy and paste this URL into your web browser's address bar <br>
                            <a
                                href="{{ route('emailVerify', ['token' => $data['token'], 'email' => $data['email']]) }}{{ $data['app'] ?? false ? '?app=true' : '' }}"
                                target="_blank"
                                style="margin: 10px auto;">{{ route('emailVerify', ['token' => $data['token'], 'email' => $data['email']]) }}{{ $data['app'] ?? false ? '?app=true' : '' }}</a>
                        </p>
                        <p style="font-weight: 400;color: #000;">Once you've verified your email address, you will be
                            redirected to a page where you can complete your profile </p>
                    </td>
                </tr>
                <tr>
                    <th>
                ...
                <tr>
                  <td align="center">
                    ...
                    <div style="border-bottom: 3px solid #000; width: 100%; margin: 10px 0;"></div>
