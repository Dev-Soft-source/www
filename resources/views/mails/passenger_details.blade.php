            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">You have received a new instant booking on ProximaRide. </p>



                        <p style="font-weight: 700;color: #000;">Booking details: </p>

                        <p style="font-weight: 400;color: #000;">Passenger name: {{ $data['passenger_first_name'] }}</p>
                        <p style="font-weight: 400;color: #000;">Passenger phone number: {{ $data['phone'] }}</p>
                        <p style="font-weight: 400;color: #000;">Passenger email: {{ $data['email'] }}</p>
                        <p style="font-weight: 400;color: #000;">Seats booked: {{ numberToWords($data['seats']) }}</p>
                        <p style="font-weight: 400;color: #000;">Booking price (total): ${{ $data['total_price'] }}</p>

                        <p style="font-weight: 700;color: #000;">Ride details:</p>
                        <p style="font-weight: 400;color: #000;">From: {{ $data['origin'] }}</p>
                        <p style="font-weight: 400;color: #000;">To: {{ $data['destination'] }}</p>
                        <p style="font-weight: 400;color: #000;">On: {{ $data['date'] }}</p>
                        <p style="font-weight: 400;color: #000;">At: {{ \Carbon\Carbon::parse($data['time'])->format('h:i A') }}</p>

                        <p style="font-weight: 400;color: #000;">Contact your passengers before the ride to explain everything to them, and be at the pick-up location 10 minutes early. If a passenger does not show up on time, call them, and gather as much detail and evidence as possible BEFORE departing </p>
                    </td>
                </tr>
                <tr>
                    <th>
                ...
                {{-- <tr>
                    <td>
                        ...
                        <p><a href="{{ route('cancellation_policy', ['lang' => $data['lang']]) }}">No Show & Cancellation Policy</a></p>
                        <p><a href="{{ route('terms_conditions', ['lang' => $data['lang']]) }}">Terms and conditions</a></p>
                        <p><a href="{{ route('dispute_policy', ['lang' => $data['lang']]) }}">Dispute Policy</a></p>
                    </td>
                </tr> --}}
                <tr>
                  <td align="center">
                                ...
                                <td align="center">
                                    <div style="display: inline-flex; flex-wrap: wrap; justify-content: center;">
                                        <a aria-label="ProximaRide" target="_blank" href="https://facebook.com"
                                            style="border: 1px solid #d1d5db; display: inline-flex; align-items: center; justify-content: center; height: 40px; width: 40px; border-radius: 50%; background-color: #fffffe; margin-right: 16px;">
