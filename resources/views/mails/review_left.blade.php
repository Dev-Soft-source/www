            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">Thank you for your time. Your review is under review and will be posted soon</p>
                        <p style="font-weight: 400;color: #000;">Have a wonderful day</p>
                    </td>
                </tr>
                <tr>
                    <th>
