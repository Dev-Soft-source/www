        ...
        <tr>
          <td style="width: 600px; max-width: 100%;background:#fff; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        <h1 style="font-weight: 700;color: #000;">🎉 New User Registration!</h1>
                        <p style="font-weight: 400;color: #000;">A new user has just signed up on ProximaRide.</p>

                        <div style="background-color: #f3f4f6; padding: 16px; border-radius: 8px; margin: 16px 0;">
                            <h3 style="margin-top: 0; color: #000;">User Details:</h3>
                            <p style="font-weight: 400;color: #000; margin: 8px 0;"><strong>Name:</strong> {{ $data['user_name'] }}</p>
                            <p style="font-weight: 400;color: #000; margin: 8px 0;"><strong>Email:</strong> {{ $data['user_email'] }}</p>
                            <p style="font-weight: 400;color: #000; margin: 8px 0;"><strong>Registration Date:</strong> {{ $data['registration_date'] }}</p>
                            <p style="font-weight: 400;color: #000; margin: 8px 0;"><strong>Platform:</strong> {{ $data['platform'] }}</p>
                        </div>

                        <p style="font-weight: 400;color: #000; margin-top: 16px;">This user will receive an email verification link and will need to verify their email before accessing all features.</p>
                    </td>
                </tr>
                <tr>
                    <th>
                ...
                <tr>
                  <td align="center">
                    ...
                    This is an automated notification email to inform you about new user registrations on the platform.
                    </p>
                  </td>
                </tr>
            </table>
