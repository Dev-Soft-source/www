        ...
        <tr>
          <td style="width: 600px; max-width: 100%;background:#fff; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        <h1 style="font-weight: 700;color: #000;font-size: 16px;">Hi {{ $data['full_name'] }},</h1>
                        <p style="font-weight: 400;color: #000;font-size: 16px;">Thank you for buying a Coffee on the Wall for our needy members. Here is your receipt of the transaction. We recommend you save this email or print it for your records:</p>

                        <table class="payment-details">
                          <tr>
                            <p style="font-weight: 700;color: #000;font-size: 16px;">Payment details:</p>
                          </tr>
                          <tr>
                            <td style="color: #000;font-size: 16px;font-weight:700;">Transaction:</td>
                            <td style="color: #000;font-size: 16px;font-weight:400;">Coffee on the Wall - Helping members in need</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td style="color: #000;font-size: 16px;font-weight:400;">{{ $data['transaction_id'] ?? 'N/A' }}</td>
                          </tr>
                          <tr>
                            <td style="color: #000;font-size: 16px;font-weight: 700;">Transaction date:</td>
                            <td style="color: #000;font-size: 16px;font-weight: 400;">{{ $data['transaction_date'] ?? Carbon\Carbon::now()->format('F j, Y \a\t H:i \E\S\T') }}</td>
                          </tr>
                          @if($data['payment_method'] == 'paypal')
                            <tr>
                              <td style="color: #000;font-size: 16px;font-weight:700;">Payment method:</td>
                              <td style="color: #000;font-size: 16px;font-weight:400;">PayPal: {{ $data['paypal_email'] ?? 'N/A' }}</td>
                            </tr>
                          @elseif($data['payment_method'] == 'stripe')
                            <tr>
                              <td style="color: #000;font-size: 16px;font-weight:700;">Payment method:</td>
                              <td style="color: #000;font-size: 16px;font-weight:400;">
                        ...
                        <p style="font-weight: 400;color: #000;font-size: 16px; margin-top: 20px;">
                          If you did not authorize this payment, believe that this email has reached you in error, or have any questions about this payment, please <a href="https://proximaride.com/en/contact-us" style="color: #3b82f6; text-decoration: underline;">contact us</a> as soon as possible and mention the transaction ID (see it above).
                        </p>
                        <p style="font-weight: 400;color: #000;font-size: 16px;">
                        ...
                        <p style="font-weight: 400;color: #000;font-size: 16px;">
                          © 2026 ProximaRide. 1051 Boul. Décarie, PO Box: 53555, Montreal, QC, H4L 3M8. All Rights Reserved
                        </p>
                    </td>
                </tr>
                <tr>
