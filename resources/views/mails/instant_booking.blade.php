            ...
            <table style="width: 100%; padding: 10px 16px;" cellpadding="0" cellspacing="0" role="none">
                <tr>
                    <td>
                        ...
                        <p style="font-weight: 400;color: #000;">{{ $data['passenger_first_name'] }} has booked seat in your ride</p>
                        @if ($data['secured_cash_code'] !== null)
                            <p style="font-weight: 400;color: #000;">The secured-cash code for this booking is: {{ $data['secured_cash_code'] }}</p>
                        @endif
                    </td>
                </tr>
                <tr>
