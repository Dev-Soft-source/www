    ...
    <div id="my-modal" class="relative z-50" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            ...
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" onclick="closeModal()"></div>
                <div
                    class="relative animate__animated animate__fadeIn transform overflow-hidden rounded-2xl bg-white text-center shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg z-20">
                ...
                <div id="search-filter-overlay" class="fixed inset-0 bg-black bg-opacity-50 hidden z-40 lg:hidden"></div>
                    ...
                    <div class="bg-white p-4 ">
                        ...
                        <div class="space-y-4 mb-4">
                            ...
                            <textarea id="keyword" class="bg-gray-100 border-0 placeholder:text-gray-900 text-black text-base md:text-lg rounded focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 block w-full p-2.5 line-clamp-2" @isset($findRidePage->search_section_keyword_placeholder) placeholder="{{$findRidePage->search_section_keyword_placeholder}}"@endisset></textarea>
                        </div>
                        ...
                        <div class="w-52 mx-auto md:mx-0 md:w-[30%]">
                            <div class="relative">
                                ...
                                <input type="text" id="dateInput" value="{{ $request->date }}"
                                    class="bg-white rounded-md md:rounded-none px-7 md:border-l border-gray-300 border-0 text-gray-900 text-lg focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 block w-full p-2.5"
