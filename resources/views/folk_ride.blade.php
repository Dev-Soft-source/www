...
@section('style')
    ...
    <style>
        ...
        .folk-ride-feature-tooltip {
            /* Inline tooltip is hidden; JS copies its content to #folk-ride-floating-tooltip */
            position: absolute;
            left: -9999px;
            opacity: 0;
            pointer-events: none;
        ...
        .folk-ride-feature-tooltip-inner p {
            color: #fff !important;
            margin: 0;
        }
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0 w-full">
                <div
                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start justify-center">
                            <!-- <div class="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full sm:mx-0 sm:h-10 sm:w-10 bg-[#ct5b5b]">
