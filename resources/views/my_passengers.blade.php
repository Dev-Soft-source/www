    ...
    <div class="container mx-auto my-10 xl:my-14 px-4 xl:px-0">
        <div class="flex justify-between">
            ...
            <button onclick="history.back()"
                class="button-exp-fill me-1 mb-4">{{ $myPassengerPage->web_back_button_label ?? 'Back' }}</button>
        </div>
                        ...
                        <div class="space-y-4 p-4">
                            ...
                            <div class="flex items-center justify-between pt-4">
                                @if (strtotime($ride->date) > strtotime('today') ||
                                    ...
                                    <div>
                                        <a href="{{ route('passenger.cancel', ['lang' => $selectedLanguage->abbreviation, 'id' => $booking->id]) }}"
                                            class="button-exp-fill me-1 bg-red-500 hover:bg-red-500 border-red-500 focus:ring-0 focus:outline-none hover:border-red-500">
                                ...
                                @if (auth()->user())
                                    @php
                                        $userBookingId = $booking->ride
                                            ...
                                            ->pluck('id')
                                            ->first();
                                        $exist = \App\Models\NoShowHistory::where('ride_id', $booking->ride_id)
                                ...
                                @if (strtotime($ride->date) < strtotime('today') ||
                                    ...
                                    @elseif ($reviewButtonVisible)
                                        ...
                                        @isset($booking->id)
                                            <td class="border border-slate-300 px-4 py-2 text-center">
                                                <a href="{{ route('review_passenger', ['lang' => $selectedLanguage->abbreviation, 'id' => $booking->id]) }}"
                                                    class="button-exp-fill me-1">
                ...
                <div class="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0 w-full">
                    <div
                        ...
                        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            ...
                            <div class="text-center sm:ml-4 sm:mt-0 sm:text-left">
                                <div class="mt-2">
                                    <p class="can-exp-p">{{ $successMessage->cancel_noshow_are_you_sure ?? 'f' }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="px-4 pb-6 pt-4 sm:flex sm:flex-row-reverse sm:px-6 justify-center">
