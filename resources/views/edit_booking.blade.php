                ...
                <div class="bg-white rounded-lg shadow-3xl">
                    ...
                    <div class="border-t border-gray-300 grid grid-cols-2 divide-x divide-gray-300">
                                    ...
                                    @if ($ride->bookings->where('status', '<>', 3)->where('status', '<>', 4)->where('user_id', auth()->user()->id)->first()->status !== '3')
                                        @if (strtotime($ride->date) > strtotime('today') ||
                                            ...
                                            <div class="flex items-baseline">
                                                ...
                                                <p class="text-xl text-primary font-normal ml-2" style="font-family: 'Carlito', Calibri, Candara, Segoe, &quot;Segoe UI&quot;, Optima, Arial, sans-serif;">{{ intval($ride->seats) -intval($ride->bookings()->where('status', '<>', 3)->where('status', '<>', 4)->whereHas('passenger', function ($query) {$query->whereNull('deleted_at');})->sum('seats')) }}</p>
                                            </div>                                            
                                        @endif
                                    @endif
                                @elseif (
                        ...
                        <div class="flex flex-wrap items-center gap-3 p-4 items-baseline">
                            ...
                            <p class="text-lg font-normal text-left text-primary" style="font-family: 'Carlito', Calibri, Candara, Segoe, &quot;Segoe UI&quot;, Optima, Arial, sans-serif;">${{ $booking->price }}
                    ...
                    <div
                        ...
                        <div class="p-4 items-baseline">
                            <h4 class="font-medium text-xl xl:text-2xl text-left text-black font-FuturaMdCnBT">
                                ...
                                @endisset
                                <span class="text-lg text-primary font-normal inline-block cursor-help" style="font-family: 'Carlito', Calibri, Candara, Segoe, &quot;Segoe UI&quot;, Optima, Arial, sans-serif;"
                        ...
                        <div class="p-4">
                            <div class="flex flex-wrap items-center gap-3 items-baseline">
                                ...
                                @isset($ride->booking_method->features_setting_id)
                                    <div class="text-lg text-primary font-normal inline-block cursor-pointer" style="font-family: 'Carlito', Calibri, Candara, Segoe, &quot;Segoe UI&quot;, Optima, Arial, sans-serif;"
