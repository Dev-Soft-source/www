<div class="space-y-2">
    ...
    <label class="block mb-4">Stops Along the Way</label>
    @foreach ($stops as $index => $stop)
        <div class="flex flex-col md:flex-row md:items-center gap-3 stop-row ml-8">
            <div class="flex flex-col md:flex-row gap-2 items-stretch flex-1 min-w-0 w-full">
    ...
    <button type="button" wire:click="addStop" class="button-exp-fill flex-shrink-0 whitespace-nowrap mb-4">+ Add a stop</button>
    ...
    @if (!is_null($pendingRemoveIndex))
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
            <div class="w-full max-w-md rounded-xl bg-white p-5 shadow-xl">
                ...
                <p class="mt-3 text-xl text-gray-600">Are you sure you want to delete this stop row?</p>
