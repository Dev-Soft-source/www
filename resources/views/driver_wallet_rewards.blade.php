        ...
        <div class="flex flex-wrap" id="tabs-id">
            <div class="w-full">
                ...
                <ul class="flex mb-0 list-none flex-wrap pt-3 pb-4 flex-row gap-2">
                    ...
                    <li class="flex-auto text-center">
                        <a href="{{ route('driver_wallet_reward', ['lang' => $selectedLanguage->abbreviation]) }}" class="text-lg font-FuturaMdCnBT font-medium px-5 py-2 shadow-lg rounded block border-blue-600 border leading-normal text-white bg-blue-600 cursor-pointer">
