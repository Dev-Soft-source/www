                                            ...
                                            <div class="col-span-4 p-4 flex justify-start items-center no-scrollbar overflow-x-auto space-x-2 md:space-x-4">
                                                ...
                                                <div class="flex items-center space-x-1">
                                                    @if ($ride->booking_method == ($postRidePage->booking_option1->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->booking_option1_tooltip }}"><img class="w-8 h-8"
                                                            src="{{ $iconSrc($postRidePage->booking_option1) }}"
                                                            alt=""></span>
                                                    @elseif ($ride->booking_method == ($postRidePage->booking_option2->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->booking_option2_tooltip }}"><img class="w-8 h-8"
                                                    ...
                                                    @if ($ride->payment_method == ($findRidePage->payment_methods_option2->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->payment_methods_option1_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->payment_methods_option2) }}" alt=""></span>
                                                    @elseif ($ride->payment_method == ($findRidePage->payment_methods_option3->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->payment_methods_option2_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->payment_methods_option3) }}" alt=""></span>
                                                    @elseif ($ride->payment_method == ($findRidePage->payment_methods_option4->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->payment_methods_option3_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->payment_methods_option4) }}" alt=""></span>
                                                    @endif
                                                    @if ($ride->smoke == ($findRidePage->smoking_option1->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->smoking_option1_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->smoking_option1) }}" alt=""></span>
                                                    @elseif ($ride->smoke == ($findRidePage->smoking_option2->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->smoking_option2_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->smoking_option2) }}" alt=""></span>
                                                    @endif
                                                    @if ($ride->animal_friendly == ($findRidePage->pets_allowed_option1->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->animals_option1_tooltip }}"><img class="w-8 h-8"
                                                    ...
                                                    @elseif ($ride->animal_friendly == ($findRidePage->pets_allowed_option2->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->animals_option2_tooltip }}"><img class="w-8 h-8"
                                                    ...
                                                    @elseif ($ride->animal_friendly == ($findRidePage->pets_allowed_option3->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->animals_option3_tooltip }}"><img class="w-8 h-8"
                                                            src="{{ $iconSrc($findRidePage->pets_allowed_option3) }}"
                                                            alt=""></span>
                                                    @endif
                                                    @if ($ride->luggage == ($findRidePage->luggage_option1->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->luggage_option1_tooltip }}"><img class="w-8 h-8"
                                                            src="{{ $iconSrc($findRidePage->luggage_option1) }}"
                                                            alt=""></span>
                                                    @elseif ($ride->luggage == ($findRidePage->luggage_option2->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->luggage_option2_tooltip }}"><img class="w-8 h-8"
                                                            src="{{ $iconSrc($findRidePage->luggage_option2) }}"
                                                            alt=""></span>
                                                    @elseif ($ride->luggage == ($findRidePage->luggage_option3->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->luggage_option3_tooltip }}"><img class="w-8 h-8"
                                                            src="{{ $iconSrc($findRidePage->luggage_option3) }}"
                                                            alt=""></span>
                                                    @elseif ($ride->luggage == ($findRidePage->luggage_option4->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->luggage_option4_tooltip }}"><img class="w-8 h-8"
                                                            src="{{ $iconSrc($findRidePage->luggage_option4) }}"
                                                            alt=""></span>
                                                    @elseif ($ride->luggage == ($findRidePage->luggage_option5->features_setting_id ?? null))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->luggage_option5_tooltip }}"><img class="w-8 h-8"
                                                    ...
                                                    @if (in_array($findRidePage->ride_features_option1->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option1_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->ride_features_option1) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($findRidePage->ride_features_option2->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option2_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->ride_features_option2) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($findRidePage->ride_features_option3->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option3_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->ride_features_option3) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($findRidePage->ride_features_option8->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option8_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->ride_features_option8) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($findRidePage->ride_features_option9->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option9_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->ride_features_option9) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($findRidePage->ride_features_option10->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option10_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->ride_features_option10) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($findRidePage->ride_features_option11->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option11_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->ride_features_option11) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($findRidePage->ride_features_option12->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option12_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->ride_features_option12) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($findRidePage->ride_features_option13->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option13_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->ride_features_option13) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($findRidePage->ride_features_option14->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option14_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->ride_features_option14) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($findRidePage->ride_features_option15->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option15_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->ride_features_option15) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($findRidePage->ride_features_option16->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option16_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($findRidePage->ride_features_option16) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($postRidePage->features_option4->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option4_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($postRidePage->features_option4) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($postRidePage->features_option5->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option5_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($postRidePage->features_option5) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($postRidePage->features_option6->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option6_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($postRidePage->features_option6) }}" alt=""></span>
                                                    @endif
                                                    @if (in_array($postRidePage->features_option7->features_setting_id ?? null, explode('=', $ride->features)))
                                                        <span class="inline-block cursor-help" data-tippy-content="{{ $postRidePage->features_option7_tooltip }}"><img class="w-8 h-8" src="{{ $iconSrc($postRidePage->features_option7) }}" alt=""></span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
