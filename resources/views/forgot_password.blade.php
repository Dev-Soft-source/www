            ...
            <div class=" bg-white rounded shadow-lg p-4 border border-gray-100">
                <div class="sm:mx-auto sm:w-full sm:max-w-md">
                    ...
                    <form class="space-y-6" method="POST" action="" id="forgot-password-form">
                        ...
                        @if (!session('error'))
                            <div id="error-modal" class="relative z-50 hidden" aria-labelledby="modal-title" role="dialog"
                        ...
                        @if (!session('message'))
                            <div id="my-modal" class="relative z-50 hidden" aria-labelledby="modal-title" role="dialog"
                                aria-modal="true">
                                <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="px-4 pb-6 pt-4 sm:flex sm:flex-row-reverse sm:px-6 justify-center">
                                                <a onclick="closeModal('my-modal', event)"
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#forgot-password-form').on('submit', function(e) {
                ...
                submitButton.html(
                    '<span class="spinner-border spinner-border-sm me-2 mt-2" role="status" aria-hidden="true"></span>Loading...'
                    );
                    ...
                    error: function(xhr) {
                        ...
                        if (xhr.status === 422) {
                            ...
                            if (response && response.error) {
                                showErrorModal(response.error, response.verify_email, response
                                    .email);
                            } else if (response && response.errors && Object.keys(response
                                    .errors).length > 0) {
