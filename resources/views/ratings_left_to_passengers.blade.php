...
<div class="grid grid-cols-12 gap-4 container mx-auto my-14">
    ...
    <div class="bg-white border rounded p-4 border-gray-200 w-full col-span-12 md:col-span-9 shadow">
        <div class="border-b pb-2">
            <h1 class="mb-0">Reviews I left</h1>
        </div>
        <ul class="flex mb-0 list-none flex-wrap pt-3 pb-4 flex-row">
            <li class="-mb-px mr-2 last:mr-0 flex-auto text-center">
                <a href="{{ route('ratings.left', ['lang' => $selectedLanguage->abbreviation]) }}" class="text-lg font-semibold px-5 py-3 shadow-lg rounded block leading-normal text-blue-600 bg-white cursor-pointer">
                    Driver I reviewed
                </a>
            </li>
            <li class="-mb-px mr-2 last:mr-0 flex-auto text-center">
                <a href="{{ route('ratings.leftToPassengers', ['lang' => $selectedLanguage->abbreviation]) }}" class="text-lg font-semibold px-5 py-3 shadow-lg rounded block leading-normal text-white bg-blue-600 cursor-pointer">
                    Passenger I reviewed
                </a>
            </li>
        </ul>
        <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mt-4">
            <div>
                <p class="text-lg">I reviewed {{ count($ratings) }} 
                    @if (count($ratings) == 1)
                        passenger
                    @else
                        passengers
                    ...
                    <div class='flex items-center justify-center space-x-4'>
                        <div class="w-2/12">
                            <div>
                                ...
                                src="{{ $rating->booking->passenger->profile_image }}"
                                alt="">
                            </div>
                        </div>
                        <div class="w-10/12">
                            <div class="flex justify-between">
                                <h6 class='card-title leading-7 m-0'>{{ $rating->booking->passenger->first_name }}</h6>
                                <a href="{{ route('review_left_passenger.index', ['lang' => $selectedLanguage->abbreviation, 'id' => $rating->id]) }}" class='card-title leading-7 m-0'>View</a>
                            </div>
