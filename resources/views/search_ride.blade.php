                                            ...
                                            <div
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <p class="flex items-center space-x-2 font-semibold">
                                                        ...
                                                        <span 
                                                            class="inline-block cursor-help ml-2"
                                                            data-tippy-content="{{ str_replace(
                                                                ':departure',
                                                                $firstSegment->departure ?? 'another city',
                                                                $findRidePage->departure_time_approximate_tooltip 
                                                                    ?? 'Departure time is . This ride starts in :departure and may be delayed by prior legs. Please wait 15–20 minutes before reporting a no-show.'
                                                            ) }}"
                                                        >
