@props(['ride', 'rideDetailPage' => null])
...
<div class="col-span-2">
    <div class="bg-white rounded-lg shadow-3xl">
        ...
        <div class="border-t border-gray-300 grid grid-cols-2 divide-x divide-gray-300">
            ...
            <div class="flex flex-row items-end gap-3 p-4 items-baseline">
                <h4 class="text-black text-xl xl:text-2xl ">
                    {{ $rideDetailPage->booking_price_label ?? 'Booking Price' }}:
                </h4>

                <p class="flex items-center gap-2 text-primary justify-end text-lg font-normal text-left text-primary">
        ...
        <div class="border-t border-gray-300 flex flex-col md:flex-row md:items-center justify-start md:space-x-2 p-4">
            ...
            @php
                ...
                $href =
                    $user && $ride->hasNonRejectedBookingForUser($user)
