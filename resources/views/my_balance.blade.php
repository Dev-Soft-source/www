            ...
            <div class="flex flex-wrap" id="tabs-id">
                <div class="w-full">
                    ...
                    <ul class="flex mb-0 list-none flex-wrap pt-3 pb-4 flex-row gap-2">
                        ...
                        <li class="flex-auto text-center">
                            <a href="{{ route('get_top_up_balance', ['lang' => $selectedLanguage->abbreviation]) }}"
                        ...
                        <li class="flex-auto text-center">
                            <a href="{{ route('passenger_wallet_rewards', ['lang' => $selectedLanguage->abbreviation]) }}"
                                class="text-lg font-FuturaMdCnBT font-medium px-5 py-2 shadow-lg rounded block border-gray-100 border leading-normal text-blue-600 bg-white cursor-pointer">
                                                                ...
                                                                <div class="{{ $key % 2 != 0 ? 'bg-gray-100' : 'bg-white' }} rounded-lg shadow-3xl border-[3px] border-solid  border-gray-100 "
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p>
                                                                            ...
                                                                            {{ $walletSettingPage->balance_id_label ?? 'ID' }}
                                                                        </p>
                                                                        <p>{{ $topUpBalance->random_id }}</p>
                                                                    </div>
                                                                    <div
                                                                        class="border-t border-gray-300 flex items-center justify-between space-x-2 p-4">
                                                                        <p>{{ $walletSettingPage->balance_amount_label ?? 'Amount' }}
                                                                        </p>
                                                                        @if ($topUpBalance->dr_amount)
                                                                            <p class="text-green-500">
                                                                                +{{ $topUpBalance->dr_amount }}</p>
                                                                        @else
                                                                            <p class="text-red-500">
                                                                                -{{ $topUpBalance->cr_amount }}</p>
                                                                        @endif
                                                                    </div>
                                                                    <div
                                                                        class="border-t border-gray-300 flex items-center justify-between space-x-2 p-4">
                                                                        <p>{{ $walletSettingPage->balance_date_label ?? 'Date' }}
                                                                        </p>
