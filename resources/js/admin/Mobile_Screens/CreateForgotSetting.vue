...
export default {
    ...
    methods: {
        ...
        fetchForgotPasswordPageSetting() {
            axios
                .get(`${process.env.MIX_ADMIN_API_URL}get-mobile-forgot-password-page-setting`)
                .then((res) => {
                    if (res?.data?.status == "Success") {
                        let mobile_forgot_password_setting_detail =
                            res?.data?.data?.mobile_forgot_password_setting_detail || [];
                        mobile_forgot_password_setting_detail.map((setting) => {
                            this.handleInput(
        ...
        updatePageSetting() {
            ...
            axios
                .post(
                    `${process.env.MIX_ADMIN_API_URL}update-mobile-forgot-password-page-setting`,
                    this.form
                )
                .then((res) => {
                    if (res?.data?.status == "Success") {
