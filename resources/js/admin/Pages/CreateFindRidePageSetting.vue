            ...
            <main class="flex-1 max-h-full p-3 bg-gray-200 pb-2">
                <div class="relative shadow-md sm:rounded-lg bg-white py-4">
                    ...
                    <div class="px-4 md:px-6 lg:px-8 mt-6 mb-6">
                        <ExcelBulkImport
                            title="Find Ride Page"
                            mode="all_languages"
                            download-endpoint="download-find-ride-page-setting-template"
                            upload-endpoint="upload-find-ride-page-setting-excel"
                            @success="fetchFindRidePageSetting"
                        />
                    </div>
                                ...
                                <div class="border rounded w-full" :class="collapseStates[0] ? 'bg-gray-50' : ''
                                    ...
                                    <div class="p-4 bg-gray-100 border-t grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6"
                                        ...
                                        <div class="relative z-0 w-full group">
                                            <div>
                                                <div class="flex justify-between">
                                                    <label :for="`pickup_at_label_${activeLanguageId}`">Pick-up at label</label>
                                                </div>
                                                <input type="text" :name="`pickup_at_label_${activeLanguageId}`"
                                        ...
                                        <div class="relative z-0 w-full group">
                                            <div>
                                                <div class="flex justify-between">
                                                    <label :for="`dropoff_at_label_${activeLanguageId}`">Drop-off at label</label>
                                                </div>
                                                <input type="text" :name="`dropoff_at_label_${activeLanguageId}`"
                                        ...
                                        <div class="relative z-0 w-full group">
                                            <div>
                                                <div class="flex justify-between">
                                                    <label :for="`total_seats_label_${activeLanguageId}`">Total seats label</label>
                                                </div>
                                                <input type="text" :name="`total_seats_label_${activeLanguageId}`"
