                ...
                <div class="relative shadow-md sm:rounded-lg bg-white py-4">
                    ...
                    <div class="px-4 md:px-6 lg:px-8 mt-6 mb-6">
                        <ExcelBulkImport
                            ...
                            mode="all_languages"
                            download-endpoint="download-forgot-password-page-setting-template"
                            upload-endpoint="upload-forgot-password-page-setting-excel"
                            @success="fetchForgotPasswordPageSetting"
                        />
                    </div>
