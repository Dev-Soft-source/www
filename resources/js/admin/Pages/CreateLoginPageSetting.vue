                ...
                <div class="relative shadow-md sm:rounded-lg bg-white py-4">
                    ...
                    <div class="px-4 md:px-6 lg:px-8 mt-6 mb-6">
                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-lg p-6 shadow-sm">
                            ...
                            <p class="text-sm text-gray-600 mb-4">Upload an Excel file with all Login page setting translations for a specific language.</p>
                            ...
                            <div class="mt-4 pt-4 border-t border-blue-200">
                                <div class="flex items-center justify-between">
                                    ...
                                    <a :href="`${mixAdminApiUrl}download-login-page-setting-template?format=single_column`" target="_blank" class="inline-flex items-center px-4 py-2 bg-green-600 text-white text-sm rounded-lg hover:bg-green-700 transition-colors duration-200"><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>Download Template</a>
                                </div>
                            </div>
                                    ...
                                    >
                                            ...
                                            <div>
                                                ...
                                                >
                                                    <label
                                                        ...
                                                        >Password placeholder (web)</label
                                                    >
                                                </div>
                                                <input
                                                    type="text"
                                        ...
                                        <div class="relative z-0 w-full group col-span-2 md:col-span-1">
                                            <div>
                                                ...
                                                >
                                                    <label
                                                        :for="`remember_me_text_${activeLanguageId}`"
                                                        >Remember me text</label
                                                    >
                                                </div>
                                                <input
                                                    type="text"
                                                    :name="`remember_me_text_${activeLanguageId}`"
                                                    :id="`remember_me_text_${activeLanguageId}`"
                                                    class="can-exp-input w-full block border border-gray-300 rounded"
                                                    placeholder=" "
                                                    :value="
                                                        getCurrentValue(
                                            ...
                                            <p
                                                ...
                                                v-if="
                                                    validationErros.has(
                                                        `remember_me_text.remember_me_text_${activeLanguageId}`
                                                    )
                                                "
                                                v-text="
                                                    validationErros.get(
                                        ...
                                        <div class="relative z-0 w-full group col-span-2 md:col-span-1">
                                            <div>
                                                ...
                                                >
                                                    <label
                                                        :for="`signup_link_label_${activeLanguageId}`"
                                                        >Signup link label (App)</label
                                                    >
                                                </div>
                                                <input
                                                    type="text"
                                                    :name="`signup_link_label_${activeLanguageId}`"
                                                    :id="`signup_link_label_${activeLanguageId}`"
                                                    class="can-exp-input w-full block border border-gray-300 rounded"
                                                    placeholder=" "
                                                    :value="
                                                        getCurrentValue(
                                            ...
                                            <p
                                                ...
                                                v-if="
                                                    validationErros.has(
                                                        `signup_link_label.signup_link_label_${activeLanguageId}`
                                                    )
                                                "
                                                v-text="
                                                    validationErros.get(
                                        ...
                                        <div class="relative z-0 w-full group col-span-2 md:col-span-1">
                                            <div>
                                                ...
                                                >
                                                    <label
                                                        :for="`new_verification_email_btn_label_${activeLanguageId}`"
                                                        >New verification email button label</label
                                                    >
                                                </div>
                                                <input
                                                    type="text"
                                                    :name="`new_verification_email_btn_label_${activeLanguageId}`"
                                                    :id="`new_verification_email_btn_label_${activeLanguageId}`"
                                                    class="can-exp-input w-full block border border-gray-300 rounded"
                                                    placeholder=" "
                                                    :value="
                                                        getCurrentValue(
                                                            'new_verification_email_btn_label'
                                                        )
                                                    "
                                                    @input="
                                                        handleInput(
                                            ...
                                            <p
                                                ...
                                                v-if="
                                                    validationErros.has(
                                                        `new_verification_email_btn_label.new_verification_email_btn_label_${activeLanguageId}`
                                                    )
                                                "
                                                v-text="
                                                    validationErros.get(
                                        ...
                                        <div class="relative z-0 w-full group col-span-2 md:col-span-1">
                                            <div>
                                                ...
                                                >
                                                    <label
                                                        :for="`protect_account_heading_${activeLanguageId}`"
                                                        >Protect account heading</label
                                                    >
                                                </div>
                                                <input
                                                    type="text"
                                                    :name="`protect_account_heading_${activeLanguageId}`"
                                                    :id="`protect_account_heading_${activeLanguageId}`"
                                                    class="can-exp-input w-full block border border-gray-300 rounded"
                                                    placeholder=" "
                                                    :value="
                                                        getCurrentValue(
                                            ...
                                            <p
                                                ...
                                                v-if="
                                                    validationErros.has(
                                                        `protect_account_heading.protect_account_heading_${activeLanguageId}`
                                                    )
                                                "
                                                v-text="
                                                    validationErros.get(
                                        ...
                                        <div class="relative z-0 w-full group col-span-2 md:col-span-1">
                                            <div>
                                                ...
                                                >
                                                    <label
                                                        :for="`protect_account_text_${activeLanguageId}`"
                                                        >Protect account text</label
                                                    >
                                                </div>
                                                <input
                                                    type="text"
                                                    :name="`protect_account_text_${activeLanguageId}`"
                                                    :id="`protect_account_text_${activeLanguageId}`"
                                                    class="can-exp-input w-full block border border-gray-300 rounded"
                                                    placeholder=" "
                                                    :value="
                                                        getCurrentValue(
                                                            'protect_account_text'
                                                        )
                                                    "
                                                    @input="
                                                        handleInput(
                                            ...
                                            <p
                                                ...
                                                v-if="
                                                    validationErros.has(
                                                        `protect_account_text.protect_account_text_${activeLanguageId}`
                                                    )
                                                "
                                                v-text="
                                                    validationErros.get(
                                        ...
                                        <div class="relative z-0 w-full group col-span-2 md:col-span-1">
                                            <div>
                                                ...
                                                >
                                                    <label
                                                        :for="`close_modal_error_message_${activeLanguageId}`"
                                                        >Close Modal Error Message</label
                                                    >
                                                </div>
                                                <input
                                                    type="text"
                                                    :name="`close_modal_error_message_${activeLanguageId}`"
                                                    :id="`close_modal_error_message_${activeLanguageId}`"
                                                    class="can-exp-input w-full block border border-gray-300 rounded"
                                                    placeholder=" "
                                                    :value="
                                                        getCurrentValue(
                                            ...
                                            <p
                                                ...
                                                v-if="
                                                    validationErros.has(
                                                        `close_modal_error_message.close_modal_error_message_${activeLanguageId}`
                                                    )
                                                "
                                                v-text="
                                                    validationErros.get(
...
export default {
    ...
    methods: {
        ...
        async uploadExcelFile() {
            ...
            try {
                const response = await axios.post(`${process.env.MIX_ADMIN_API_URL}upload-login-page-setting-excel`, formData, { headers: { 'Content-Type': 'multipart/form-data' } });
                if (response?.data?.status === 'Success') {
                    ...
                    setTimeout(() => { this.getLoginPageSetting && this.getLoginPageSetting(); }, 1000);
                } else {
                ...
                .then((res) => {
                    if (res?.data?.status == "Success") {
                        ...
                        languages.map((language) => {
                            ...
                            this.handleInput("", language, "continue_label");
                            this.handleInput("", language, "new_verification_email_btn_label");
                            ...
                            this.handleInput("", language, "remember_me_text");
                            ...
                            this.handleInput("", language, "signup_link_label");
                            this.handleInput("", language, "now_label");
                            this.handleInput("", language, "language_label");
                            this.handleInput("", language, "protect_account_heading");
                            this.handleInput("", language, "protect_account_text");
                            this.handleInput("", language, "close_modal_error_message");
                        });
        ...
        fetchLoginPageSetting() {
            axios
                .get(`${process.env.MIX_ADMIN_API_URL}get-login-page-setting`)
                .then((res) => {
                    if (res?.data?.status == "Success") {
                        let login_page_setting_detail =
                            res?.data?.data?.login_page_setting_detail || [];
                        login_page_setting_detail.map((setting) => {
                            this.handleInput(
                                setting?.name,
                                setting?.language,
                                "name"
                            ...
                            this.handleInput(
                                setting?.continue_label,
                                setting?.language,
                                "continue_label"
                            );
                            this.handleInput(
                                setting?.new_verification_email_btn_label,
                                setting?.language,
                                "new_verification_email_btn_label"
                            );
                            this.handleInput(
                            ...
                            this.handleInput(
                                setting?.protect_account_heading,
                                setting?.language,
                                "protect_account_heading"
                            );
                            this.handleInput(
                                setting?.protect_account_text,
                                setting?.language,
                                "protect_account_text"
                            );
                            this.handleInput(
                                setting?.close_modal_error_message,
                                setting?.language,
                                "close_modal_error_message"
                            );
                        });
        ...
        updatePageSetting() {
            ...
            axios
                .post(
                    `${process.env.MIX_ADMIN_API_URL}update-login-page-setting`,
                    this.form
                )
                .then((res) => {
                    if (res?.data?.status == "Success") {
        ...
        checkValidationError(validationErros, language) {
            return (
                ...
                validationErros.has(
                    `new_verification_email_btn_label.new_verification_email_btn_label_${language.id}`
                ) ||
                validationErros.has(
                ...
                validationErros.has(
                    `signup_link_label.signup_link_label_${language.id}`
                ) ||
                validationErros.has(
                ...
                validationErros.has(
                    `remember_me_text.remember_me_text_${language.id}`
                ) ||
                validationErros.has(
                ...
                validationErros.has(
                    `protect_account_text.protect_account_text_${language.id}`
                ) ||
                validationErros.has(
                    `protect_account_text.protect_account_text_${language.id}`
                ) ||
                validationErros.has(
                    `close_modal_error_message.close_modal_error_message_${language.id}`
                )
            );
        },
    },
