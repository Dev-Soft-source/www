                    ...
                    <div class="px-4 md:px-6 lg:px-8 mt-6 mb-6">
                        <div
                            ...
                            <div class="flex items-center mb-4">
                                ...
                                <h4 class="text-xl font-bold text-gray-800">📊 Excel Upload - Bulk Import Translations
                                </h4>
                            </div>
                            <p class="text-sm text-gray-600 mb-4">
                                Upload an Excel file with all chats & notifications page setting translations for a
                                specific language.
                            </p>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <select v-model="excelForm.selectedLanguageId"
                                    ...
                                    <p v-if="excelValidationErrors.language_id" class="text-red-500 text-xs mt-1">{{
                                        excelValidationErrors.language_id }}</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p v-if="excelValidationErrors.excel_file" class="text-red-500 text-xs mt-1">{{
                                        excelValidationErrors.excel_file }}</p>
                                    <p class="text-xs text-gray-500 mt-1">Supported: .xlsx, .xls, .csv (Max: 5MB)</p>
                                </div>

                                <div class="flex items-end">
                                    <button type="button" @click="uploadExcelFile" :disabled="excelUploading"
                            ...
                            <div class="mt-4 pt-4 border-t border-blue-200">
                                <div class="flex items-center justify-between">
                                    ...
                                    <a :href="`${mixAdminApiUrl}download-chats-page-setting-template?format=single_column`"
                                        target="_blank"
                            ...
                            <div v-if="excelErrors.length > 0"
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="flex-1">
                                        <h5 class="text-red-800 font-semibold mb-2">Validation Errors in Excel File:
                                        </h5>
                                        <ul class="list-disc list-inside space-y-1">
                                            <li v-for="(error, index) in excelErrors" :key="index"
                                                class="text-sm text-red-700">
                                                <strong>Row {{ error.row }}:</strong> {{ error.attribute }} - {{
                                                    error.errors.join(', ') }}
                                            </li>
                                        </ul>
                                    </div>
