        ...
        <section class="privacy-policy-section relative md:top-16">
            <main class="flex-1 max-h-full p-3 bg-gray-200 pb-2">
                <div class="relative shadow-md sm:rounded-lg bg-white py-4">
                    ...
                    >
                        <ExcelBulkImport
                            title="Privacy Policy page settings"
                            mode="all_languages"
                            :languages="languages"
                            download-endpoint="download-privacy-policy-page-setting-template"
                            upload-endpoint="upload-privacy-policy-page-setting-excel"
