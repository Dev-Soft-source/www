            ...
            <main class="flex-1 max-h-full p-3 bg-gray-200 pb-2">
                <div class="relative shadow-md sm:rounded-lg bg-white py-4">
                    ...
                    <div class="px-4 md:px-6 lg:px-8 mt-6 mb-6">
                        <ExcelBulkImport
                            title="Firm Cancellation Page"
                            mode="all_languages"
                            download-endpoint="download-firm-cancellation-page-setting-template"
                            upload-endpoint="upload-firm-cancellation-page-setting-excel"
