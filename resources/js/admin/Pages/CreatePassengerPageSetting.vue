        ...
        <section class="passenger-section relative md:top-16">
            <main class="flex-1 max-h-full p-3 bg-gray-200 pb-2">
                <div class="relative shadow-md sm:rounded-lg bg-white py-4">
                    ...
                    <ExcelBulkImport
                        title="Passengers page"
                        mode="all_languages"
                        download-endpoint="download-passenger-page-setting-template"
                        upload-endpoint="upload-passenger-page-setting-excel"
                        @success="fetchPassengerPageSetting"
                    />
