            ...
            <main class="flex-1 max-h-full p-3 bg-gray-200 pb-2">
                <div class="relative shadow-md sm:rounded-lg bg-white py-4">
                    ...
                    <ExcelBulkImport
                        ...
                        mode="all_languages"
                        download-endpoint="download-terms-and-condition-page-setting-template"
                        upload-endpoint="upload-terms-and-condition-page-setting-excel"
                        @success="fetchTermsAndConditionPageSetting"
                    />
                    <form
