                                    ...
                                    <tr v-for="student in sortedStudents" :key="student.id"
                                        ...
                                        <td class="p-2 md:p-3 hidden md:table-cell">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <button v-if="student.suspand == 0" type="button"
                                                    ...
                                                    title="Suspend user" @click.prevent="suspandUser(student)">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                        class="w-5 h-5">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                <button v-else type="button"
                                                    ...
                                                    title="Unsuspend user" @click.prevent="unSuspandUser(student)">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                        class="w-5 h-5">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                <button type="button"
                                                    ...
                                                    title="Delete user" @click.prevent="deleteStudent(student)">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                        class="w-5 h-5">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
