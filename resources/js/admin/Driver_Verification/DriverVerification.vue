                                    ...
                                    <tr v-for="driver in drivers" :key="driver.id"
                                        ...
                                        <td
                                            ...
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <!-- <router-link
                                                    :to="{ name: 'admin.driver.index', params: { id: driver.id } }"
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <a v-if="driver.suspand == 0" href="#"
                                                    ...
                                                    @click.prevent="suspandUser(driver)">
                                                    Suspend
                                                </a>
                                                <a v-if="driver.suspand == 1" href="#"
                                                    class="inline-flex items-center bg-gray-100 hover:bg-gray-200 hover:border-gray-200 hover:text-black button-exp-fill cursor-pointer border-gray-100 text-black"
                                                    @click.prevent="unSuspandUser(driver)">
                                                    Unsuspend
                                                </a>
                                                <a href="#"
                                                    ...
                                                    @click.prevent="deleteDriver(driver)">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
