                                    ...
                                    <div
                                        ...
                                        <div>
                                            <input id="bordered-radio-3-yes" type="radio" name="email_verified"
                                                :checked="user.email_verified === '1'" :value="'1'"
                                        ...
                                        <div>
                                            <input id="bordered-radio-3-no" type="radio" name="email_verified"
                                                :checked="user.email_verified === '0'" :value="'0'"
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <input id="bordered-radio-5-yes" type="radio" name="driver_verified"
                                                :checked="user.driver === '1'" :value="'1'"
                                                @change="approveDriver(user)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="bordered-radio-5-yes">Yes</label>
                                        </div>
                                        <div>
                                            <input id="bordered-radio-5-no" type="radio" name="driver_verified"
                                                :checked="user.driver === '3'" :value="'3'" @change="rejectDriver(user)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                            ...
                            <tr v-if="user.student !== '0'">
                                ...
                                <td>
                                    <div
                                        class="flex gap-4 md:justify-normal justify-between md:gap-x-8 items-center mt-2 p-1.5">
                                        <div>
                                            <input id="student-verification-yes" type="radio"
                                                name="student_verification" :checked="user.student === '1'" :value="'1'"
                                                @change="updateStudentVerification(1)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="student-verification-yes">Yes</label>
                                        </div>
                                        <div>
                                            <input id="student-verification-no" type="radio" name="student_verification"
                                                :checked="user.student === '3'" :value="'3'"
                            ...
                            <tr v-else>
                                ...
                                <td>
                                    <div
                                        class="flex gap-4 md:justify-normal justify-between md:gap-x-8 items-center mt-2 p-1.5">
                                        <div>
                                            <input id="student-verification-yes-disabled" type="radio"
                                                name="student_verification" :checked="user.student === '1'" :value="'1'"
                                                disabled
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                        ...
                                        <div>
                                            <input id="student-verification-no-disabled" type="radio"
                                                name="student_verification" :checked="user.student === '3'" :value="'3'"
                                                disabled
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div
                                        class="flex gap-4 md:justify-normal justify-between md:gap-x-8 items-center mt-2 p-1.5">
                                        <div>
                                            <input id="pink-ride-enable" type="radio" name="pink_ride"
                                                :checked="user.pink_ride === '1'" :value="'1'"
                                                @change="updatePinkRideStatus(1)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="pink-ride-enable">Enable</label>
                                        </div>
                                        <div>
                                            <input id="pink-ride-disable" type="radio" name="pink_ride"
                                                :checked="user.pink_ride === '0'" :value="'0'"
                                                @change="updatePinkRideStatus(0)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="pink-ride-disable">Disable</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="pink-ride-default" type="radio" name="pink_ride"
                                                :checked="user.pink_ride === ''" :value="''"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div
                                        class="flex gap-4 md:justify-normal justify-between md:gap-x-8 items-center mt-2 p-1.5">
                                        <div>
                                            <input id="folks-ride-enable" type="radio" name="folks_ride"
                                                :checked="user.folks_ride === '1'" :value="'1'"
                                                @change="updateFolkRideStatus(1)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="folks-ride-enable">Enable</label>
                                        </div>
                                        <div>
                                            <input id="folks-ride-disable" type="radio" name="folks_ride"
                                                :checked="user.folks_ride === '0'" :value="'0'"
                                                @change="updateFolkRideStatus(0)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="folks-ride-disable">Disable</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="folks-ride-default" type="radio" name="folks_ride"
                                                :checked="user.folks_ride === ''" :value="''"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div
                                        class="flex gap-4 md:justify-normal justify-between md:gap-x-8 items-center mt-2 p-1.5">
                                        <div>
                                            <input id="government-id-yes" type="radio" name="government_issued_id"
                                                :checked="user.government_issued_id !== '' && user.government_id !== '1'"
                                                :value="'0'" @change="updateGovernmentId(0)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="government-id-yes">Yes</label>
                                        </div>
                                        <div>
                                            <input id="government-id-no" type="radio" name="government_issued_id"
                                                :checked="user.government_issued_id === '' || user.government_id === '1'"
                                                :value="'1'" @change="updateGovernmentId(1)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
