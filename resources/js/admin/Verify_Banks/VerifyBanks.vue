            ...
            <div class="px-4">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h3 class="can-exp-h2 text-primary text-center sm:text-left" v-if="verify_banks">Verify banks
                            <small v-if="verify_banks">({{ verify_banks.length }})</small>
                        </h3>
                    </div>
                </div>
                                ...
                                <tbody class="flex-1 text-gray-700 sm:flex-none">
                                    <tr v-for="verify_bank in verify_banks" :key="verify_bank.id"
                                        ...
                                        <td
                                            ...
                                            <div v-if="verify_bank.status === 'pending'"
                                                class="flex items-center space-x-2">
                                                <button class="inline-flex items-center button-exp-fill cursor-pointer"
                                                    type="button" v-on:click="toggleModal2(verify_bank)">
                                                    Verify
                                                </button>
                                            </div>
                                        </td>
            ...
            <div class="relative my-6 mx-auto w-1/2 max-w-6xl">
                ...
                <div
                    ...
                    <div class="relative p-6 flex-auto">
                        ...
                        <p class="mt-2 text-sm text-red-400" v-if="validationErros.has('admin_verify_amount')"
                            v-text="validationErros.get('admin_verify_amount')"></p>
                    </div>
                    <!--footer-->
                    <div class="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                        <a href="#"
