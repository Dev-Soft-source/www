            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h3 class="can-exp-h2 text-primary text-center sm:text-left">Countries</h3>
                    </div>
                    <div class="mt-4 sm:mt-0 sm:ml-16 flex justify-center">
                        <router-link :to="{ name: 'admin.countries.create' }" class="block button-exp-fill w-full">
                            Add new country
                        </router-link>
                    </div>
                </div>
                <div class="flex flex-col sm:flex-col md:flex-row lg:flex-row items-center justify-between gap-4 py-4">
                    ...
                    <div class="relative w-full md:w-auto">
                        ...
                        <input type="text" id="table-search-countries"
                            class="block  pl-10  w-full md:w-80 bg-white can-exp-input"
                            placeholder="Search for countries" v-model="quickSearch" />
                    </div>
                </div>
                            ...
                            <table
                                ...
                                <tbody class="flex-1 text-gray-700 sm:flex-none">
                                    <tr v-for="country in countries" :key="country.id"
                                        ...
                                        <td
                                            class="py-2 md:p-3 border-none max-[767px]:flex items-center justify-between">
                                        ...
                                        <td
                                            ...
                                            <!-- <label class="text-xs text-gray-500 uppercase font-semibold md:hidden" for="">Action</label> -->
                                            <!-- <router-link
                                                :to="{ name: 'admin.countries.edit', params: { id: country.id } }"
                                            ...
                                            <a :href="$router.resolve({ name: 'admin.countries.edit', params: { id: country.id } }).href"
                                    ...
                                    <div>
                                        <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px"
                                            ...
                                            <a href="#"
                                                ...
                                                @click.prevent="pagination.prev_page_url && fetchCountries(pagination.prev_page_url)">
                                                Previous
                                            </a>
                                            <template v-for="(link, index) in pagination.links" :key="index">
                                                <a v-if="link.url && !link.label.includes('Previous') && !link.label.includes('Next')"
                                                    ...
                                                    @click.prevent="fetchCountries(link.url)">
                                            ...
                                            <a href="#"
                                                ...
                                                @click.prevent="pagination.next_page_url && fetchCountries(pagination.next_page_url)">
                                                Next
                                            </a>
                                        </nav>
                                    </div>
...
export default {
    ...
    computed: {
        ...
        limit: {
            get() {
                return this.$store.state.countries.limit;
            },
            set(value) {
            ...
            this.$swal
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        this.$store.dispatch("countries/deleteCountry", {
                            id: country.id,
                        })
                            .then((res) => {
    ...
    created() {
        ...
        this.$store.commit("countries/setSortType", "desc");
