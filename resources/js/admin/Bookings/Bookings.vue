            ...
            <div class="px-4">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h3 class="can-exp-h2 text-primary text-center sm:text-left" v-if="bookings">All bookings <small v-if="bookings">({{ bookings.length }})</small></h3>
                    </div>
                </div>
                                ...
                                <tbody class="flex-1 text-gray-700 sm:flex-none">
                                    <tr v-for="booking in bookings" :key="booking.id"
                                        ...
                                        <td class="p-2 md:p-3 md:border-none">
                                            <label class="text-gray-500 font-FuturaMdCnBT md:hidden text-xl"
                                                for="">Payment</label>
                                            <div>Price/Seat: ${{ (booking . price / booking . seats).toFixed(2) }} CAD<br>
                                    ...
                                    <div>
                                        <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px"
                                            ...
                                            <a href="#"
                                                ...
                                                @click="fetchBookings(pagination.prev_page_url)">
                                            ...
                                            <a href="#"
                                                ...
                                                @click.prevent="fetchBookings(pagination.next_page_url)">
                                ...
                                <div>
                                    <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                                        <a href="#"
                                            ...
                                            @click.prevent="pagination.prev_page_url && fetchBookings(pagination.prev_page_url)">
                                            Previous
                                        </a>
                                        <template v-for="(link, index) in pagination.links" :key="index">
                                            <a v-if="link.url && !link.label.includes('Previous') && !link.label.includes('Next')"
                                                ...
                                                @click.prevent="fetchBookings(link.url)">
                                        ...
                                        <a href="#"
                                            ...
                                            @click.prevent="pagination.next_page_url && fetchBookings(pagination.next_page_url)">
                                            Next
                                        </a>
                                    </nav>
                                </div>
...
export default {
    ...
    methods: {
        ...
        //     this.$store.dispatch("bookings/fetchBookings", { url: page_url });
        // },
        fetchBookings(page_url) {
            if (!page_url) {
                return;
