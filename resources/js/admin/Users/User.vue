            ...
            <header class="py-4">
                <div class="max-w-full mx-auto px-4">
                    <div class="flex items-center justify-between">
                        <h3 v-if="user.first_name || user.last_name" class="can-exp-h2 text-primary">
                    ...
                    <table class="table table-striped table-fixed w-full">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div
                                        class="flex gap-4 md:justify-normal justify-between md:gap-x-8 items-center mt-2 p-1.5">
                                        <div>
                                            <input id="bordered-radio-3-yes" type="radio" name="email_verified"
                                                v-model="user.email_verified" :value="'1'"
                                                @change="updateEmailVerified(1)"
                                        ...
                                        <div>
                                            <input id="bordered-radio-3-no" type="radio" name="email_verified"
                                                v-model="user.email_verified" :value="'0'"
                                                @change="updateEmailVerified(0)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                            ...
                            <tr v-if="user.driver !== '0'">
                                ...
                                <td>
                                    <div
                                        class="flex gap-4 md:justify-normal justify-between md:gap-x-8 items-center mt-2 p-1.5">
                                        <div>
                                            <input id="bordered-radio-5-yes" type="radio" name="driver_verified"
                                                v-model="user.driver" :value="'1'" @change="approveDriver(user)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="bordered-radio-5-yes">Yes</label>
                                        </div>
                                        <div>
                                            <input id="bordered-radio-5-no" type="radio" name="driver_verified"
                                                v-model="user.driver" :value="'3'" @change="rejectDriver(user)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                            ...
                            <tr v-else>
                                ...
                                <td>
                                    <div
                                        ...
                                        <div>
                                            <input id="bordered-radio-5-no" type="radio" name="driver_verified" disabled
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="bordered-radio-5-no">No</label>
                                        </div>
                                    </div>
                            ...
                            <tr v-if="user.student !== '0'">
                                ...
                                <td>
                                    <div
                                        class="flex gap-4 md:justify-normal justify-between md:gap-x-8 items-center mt-2 p-1.5">
                                        <div>
                                            <input id="bordered-radio-2-yes" type="radio" name="student_verification"
                                                v-model="user.student" :value="'1'"
                                                @change="updateStudentVerification(1)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="bordered-radio-2-yes">Yes</label>
                                        </div>
                                        <div>
                                            <input id="bordered-radio-2-no" type="radio" name="student_verification"
                                                v-model="user.student" :value="'3'"
                                                @change="updateStudentVerification(3)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                            ...
                            <tr v-else>
                                ...
                                <td>
                                    <div
                                        ...
                                        <div>
                                            <input id="bordered-radio-2-yes" type="radio" name="student_verification"
                                                v-model="user.student" :value="'1'" disabled
                                                @change="updateStudentVerification(1)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="bordered-radio-2-yes">Yes</label>
                                        </div>
                                        <div>
                                            <input id="bordered-radio-2-no" type="radio" name="student_verification"
                                                v-model="user.student" :value="'3'" disabled
                                                @change="updateStudentVerification(3)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="bordered-radio-2-no">No</label>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div
                                        class="flex gap-4 md:justify-normal justify-between md:gap-x-8 items-center mt-2 p-1.5">
                                        <div>
                                            <input id="bordered-radio-2-yes" type="radio" name="pink_ride"
                                                v-model="user.pink_ride" :value="'1'" :checked="user.pink_ride === '1'"
                                                @change="updatePinkRideStatus(1)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="bordered-radio-2-yes">Enable</label>
                                        </div>
                                        <div>
                                            <input id="bordered-radio-2-no" type="radio" name="pink_ride"
                                                v-model="user.pink_ride" :value="'0'" :checked="user.pink_ride === '0'"
                                                @change="updatePinkRideStatus(0)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="bordered-radio-2-no">Disable</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="bordered-radio-2-none" type="radio" name="pink_ride"
                                                v-model="user.pink_ride" :value="''" :checked="user.pink_ride === ''"
                                                @change="updatePinkRideStatus('')"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div
                                        class="flex gap-4 md:justify-normal justify-between md:gap-x-8 items-center mt-2 p-1.5">
                                        <div>
                                            <input id="bordered-radio-2-yes" type="radio" name="folks_ride"
                                                v-model="user.folks_ride" :value="'1'"
                                                :checked="user.folks_ride === '1'" @change="updateFolkRideStatus(1)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="bordered-radio-2-yes">Enable</label>
                                        </div>
                                        <div>
                                            <input id="bordered-radio-2-no" type="radio" name="folks_ride"
                                                v-model="user.folks_ride" :value="'0'"
                                                :checked="user.folks_ride === '0'" @change="updateFolkRideStatus(0)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="bordered-radio-2-no">Disable</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="bordered-radio-2-none" type="radio" name="folks_ride"
                                                v-model="user.folks_ride" :value="''" :checked="user.folks_ride === ''"
                                                @change="updateFolkRideStatus('')"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="bordered-radio-2-none">Default</label>
                                            <p class="text-sm font-semibold"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div
                                        class="flex gap-4 md:justify-normal justify-between md:gap-x-8 items-center mt-2 p-1.5">
                                        <div>
                                            <input id="bordered-radio-2-yes" type="radio" name="government_issued_id"
                                                v-model="user.government_id" :value="'0'"
                                                :checked="user.government_issued_id !== '' && user.government_id !== '1'"
                                                @change="updateGovernmentId(0)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="bordered-radio-2-yes">Yes</label>
                                        </div>
                                        <div>
                                            <input id="bordered-radio-2-no" type="radio" name="government_issued_id"
                                                v-model="user.government_id" :value="'1'"
                                                :checked="user.government_issued_id === '' || user.government_id === '1'"
                                                @change="updateGovernmentId(1)"
                                                class="w-4 h-4 me-1 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-none">
                                            <label for="bordered-radio-2-no">No</label>
                                        </div>
                                    </div>
                    ...
                    <table class="table table-striped table-fixed w-full">
                        <tbody>
                            ...
                            <tr v-if="user.government_issued_id">
                                ...
                                <td><a :href="user.government_issued_id" target="_blank">{{ user.government_issued_id
                                        }}</a></td>
                            </tr>
                        </tbody>
                    </table>
