...
const extraCareFaqs = {
    ...
    mutations: {
        ...
        setextraCareFaqs(state, payload) {
            state.extraCareFaqs = payload;
        },
    ...
    actions: {
                ...
                axios.get(url)
                    .then((res) => {
                        if (res.data.status == "Success") {
                            ...
                            commit("setextraCareFaqs", res.data.data);
                            resolve(res);
                        }
                    })
                    .catch((error) => {
        ...
        deleteExtraCareFaq({ commit }, payload) {
            commit("setLoading");
            let url = payload && payload.url
                    ? payload.url
