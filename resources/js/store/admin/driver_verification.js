const drivers = {
    ...
    actions: {
        fetchDrivers({ commit, state }, payload) {
        ...
        async deleteDriver({ commit }, payload) {
            ...
            try {
              ...
              if (res && res.data && res.data.status === "Success") {
                ...
                commit("removeDriverById", payload.id);
