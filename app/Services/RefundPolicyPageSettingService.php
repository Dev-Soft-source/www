...
class RefundPolicyPageSettingService
{
    ...
    public function fields($refundPolicyPageSetting, $language, $request)
    {
        return [
            'refund_policy_page_id' => $refundPolicyPageSetting->id,
    ...
    public function update($refundPolicyPageSetting, $language, $request)
    {
        $fields = $this->fields($refundPolicyPageSetting, $language, $request);
        $refundPolicyPageSettingDetail = RefundPolicyPageSettingDetail::whereRefundPolicyPageId($refundPolicyPageSetting->id)->whereLanguageId($language->id)->exists();
        if(!$refundPolicyPageSettingDetail){
            $fields = $this->fields($refundPolicyPageSetting, $language, $request);
