...
class PostRidePageSettingService
{
    public function validation($languages, $validationRule, $errorMessages)
    {
        ...
        foreach ($languages as $language) {
            if ($language->is_default == '1') {
                ...
                $errorMessages = array_merge($errorMessages, ['price_error_adjust_btn_label.price_error_adjust_btn_label_' . $language->id . '.required' => 'This field in ' . $language->name . ' is required.']);
    ...
    public function fields($postRidePageSetting, $language, $request)
    {
        return [
            ...
            'stop_suggest_label' => $this->data($request, $language, 'stop_suggest_label'),
            ...
            'stops_remove_confirm_text' => $this->data($request, $language, 'stops_remove_confirm_text'),
            'distance_suffix' => $this->data($request, $language, 'distance_suffix'),
            ...
            'delete_stop_modal_yes_btn' => $this->data($request, $language, 'delete_stop_modal_yes_btn'),
            ...
            'seats_warning_modal_learn_more_btn' => $this->data($request, $language, 'seats_warning_modal_learn_more_btn'),
            'phone_required_modal_heading' => $this->data($request, $language, 'phone_required_modal_heading'),
            'phone_required_modal_body_before' => $this->data($request, $language, 'phone_required_modal_body_before'),
            'phone_required_modal_link_text' => $this->data($request, $language, 'phone_required_modal_link_text'),
