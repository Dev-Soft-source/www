...
class EditProfileSettingService
{
    ...
    public function fields($editProfileSetting, $language, $request)
    {
        return [
            ...
            'notification_label' => $this->data($request, $language, 'notification_label'),
            'email_notification_label' => $this->data($request, $language, 'email_notification_label'),
            'sms_notification_label' => $this->data($request, $language, 'sms_notification_label'),
