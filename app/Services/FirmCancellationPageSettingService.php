...
class FirmCancellationPageSettingService
{
    ...
    {
        return [
            'firm_cancellation_id' => $cancellationPageSetting->id,
    ...
    public function update($cancellationPageSetting, $language, $request)
    {
        ...
        $cancellationPageSettingDetail = FirmCancellationPageSettingDetail::where('firm_cancellation_id',$cancellationPageSetting->id)->whereLanguageId($language->id)->exists();
