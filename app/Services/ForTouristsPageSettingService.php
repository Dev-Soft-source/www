...
class ForTouristsPageSettingService
{
    ...
    public function fields($forTouristsPageSetting, $language, $request)
    {
        return [
            'for_tourists_page_id' => $forTouristsPageSetting->id,
    ...
    public function update($forTouristsPageSetting, $language, $request)
    {
        $fields = $this->fields($forTouristsPageSetting, $language, $request);
        $forTouristsPageSettingDetail = ForTouristsPageSettingDetail::whereForTouristsPageId($forTouristsPageSetting->id)->whereLanguageId($language->id)->exists();
