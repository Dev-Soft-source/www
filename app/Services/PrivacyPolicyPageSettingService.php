...
class PrivacyPolicyPageSettingService
{
    ...
    public function fields($privacyPolicyPageSetting, $language, $request)
    {
        return [
            'privacy_page_id' => $privacyPolicyPageSetting->id,
    ...
    public function update($privacyPolicyPageSetting, $language, $request)
    {
        $fields = $this->fields($privacyPolicyPageSetting, $language, $request);
        $privacyPolicyPageSettingDetail = PrivacyPolicyPageSettingDetail::wherePrivacyPageId($privacyPolicyPageSetting->id)->whereLanguageId($language->id)->exists();
        if(!$privacyPolicyPageSettingDetail){
            $fields = $this->fields($privacyPolicyPageSetting, $language, $request);
