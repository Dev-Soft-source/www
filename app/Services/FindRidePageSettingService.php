    ...
    public function validation($languages, $validationRule, $errorMessages)
    {
        ...
        foreach ($languages as $language) {
            if ($language->is_default == '1') {
                ...
                $validationRule = array_merge($validationRule, ['luggage_any_label.luggage_any_label_' . $language->id => ['nullable', 'string']]);
                ...
                $validationRule = array_merge($validationRule, ['smoking_any_label.smoking_any_label_' . $language->id => ['nullable', 'string']]);
                ...
                $validationRule = array_merge($validationRule, ['pets_any_label.pets_any_label_' . $language->id => ['nullable', 'string']]);
