...
class TripsPageSettingService
{
    ...
    public function fields($tripsPageSetting, $language, $request)
    {
        return [
            ...
            'cancel_ride_confirm_modal_title' => $this->data($request, $language, 'cancel_ride_confirm_modal_title'),
            'cancel_ride_confirm_modal_message' => $this->data($request, $language, 'cancel_ride_confirm_modal_message'),
            'cancel_ride_confirm_modal_no_btn_text' => $this->data($request, $language, 'cancel_ride_confirm_modal_no_btn_text'),
            'cancel_ride_confirm_modal_yes_btn_text' => $this->data($request, $language, 'cancel_ride_confirm_modal_yes_btn_text'),
