...
class CommunityGuidelinesPageSettingService
{
    ...
    public function fields($communityGuidelinesPageSetting, $language, $request)
    {
        return [
            'community_guidelines_page_id' => $communityGuidelinesPageSetting->id,
    ...
    public function update($communityGuidelinesPageSetting, $language, $request)
    {
        $fields = $this->fields($communityGuidelinesPageSetting, $language, $request);
        $communityGuidelinesPageSettingDetail = CommunityGuidelinesPageSettingDetail::whereCommunityGuidelinesPageId($communityGuidelinesPageSetting->id)->whereLanguageId($language->id)->exists();
