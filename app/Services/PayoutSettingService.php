...
class PayoutSettingService
{
    ...
    public function fields($payoutSetting, $language, $request)
    {
        return [
            ...
            'web_interac_transfer_description' => $this->data($request, $language, 'web_interac_transfer_description'),
            'wallet_intro_line1' => $this->data($request, $language, 'wallet_intro_line1'),
            'wallet_intro_line2' => $this->data($request, $language, 'wallet_intro_line2'),
            'interac_detail_heading' => $this->data($request, $language, 'interac_detail_heading'),
            'interac_autodeposit_info_paragraph' => $this->data($request, $language, 'interac_autodeposit_info_paragraph'),
            'processing_fee_text' => $this->data($request, $language, 'processing_fee_text'),
            'save_payout_method_btn' => $this->data($request, $language, 'save_payout_method_btn'),
            'bank_detail_info_paragraph' => $this->data($request, $language, 'bank_detail_info_paragraph'),
            'bank_funds_note' => $this->data($request, $language, 'bank_funds_note'),
            'paypal_detail_info_paragraph' => $this->data($request, $language, 'paypal_detail_info_paragraph'),
            'paypal_fee_heading' => $this->data($request, $language, 'paypal_fee_heading'),
            'paypal_fee_proximaride_text' => $this->data($request, $language, 'paypal_fee_proximaride_text'),
            'paypal_fee_receiving_text' => $this->data($request, $language, 'paypal_fee_receiving_text'),
            'paypal_fee_example_text' => $this->data($request, $language, 'paypal_fee_example_text'),
            'refund_footer_paragraph' => $this->data($request, $language, 'refund_footer_paragraph'),
            'interac_autodeposit_label' => $this->data($request, $language, 'interac_autodeposit_label'),
            'interac_autodeposit_tooltip' => $this->data($request, $language, 'interac_autodeposit_tooltip'),
            'interac_autodeposit_text_before' => $this->data($request, $language, 'interac_autodeposit_text_before'),
            'interac_autodeposit_highlight' => $this->data($request, $language, 'interac_autodeposit_highlight'),
            'interac_autodeposit_text_after' => $this->data($request, $language, 'interac_autodeposit_text_after'),
            'interac_email_label' => $this->data($request, $language, 'interac_email_label'),
            'interac_email_confirm_label' => $this->data($request, $language, 'interac_email_confirm_label'),
            'interac_email_placeholder' => $this->data($request, $language, 'interac_email_placeholder'),
            'interac_email_confirm_placeholder' => $this->data($request, $language, 'interac_email_confirm_placeholder'),
            'paypal_email_confirm_label' => $this->data($request, $language, 'paypal_email_confirm_label'),
            'paypal_email_confirm_placeholder' => $this->data($request, $language, 'paypal_email_confirm_placeholder'),
