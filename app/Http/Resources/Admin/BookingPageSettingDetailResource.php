...
class BookingPageSettingDetailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'pink_ride_tooltip' => $this->pink_ride_tooltip,
            'extra_care_ride_tooltip' => $this->extra_care_ride_tooltip,
            ...
            'fee_student_pending_text' => $this->fee_student_pending_text,
            'fee_charge_waived' => $this->fee_charge_waived,
            'coffee_wall_cash_text' => $this->coffee_wall_cash_text,
            'coffee_wall_online_payment_text' => $this->coffee_wall_online_payment_text,
            'coffee_wall_secure_cash_text' => $this->coffee_wall_secure_cash_text,
            'note_for_students_text' => $this->note_for_students_text,
