...
class BillingAddressSettingDetailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'buy_btn_text' => $this->buy_btn_text,
            'top_up_my_balance_head' => $this->top_up_my_balance_head,
            'purchase_amount_label' => $this->purchase_amount_label,
            'purchase_amount_placeholder' => $this->purchase_amount_placeholder,
