...
class TripsPageSettingDetailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'cancel_ride_confirm_modal_title' => $this->cancel_ride_confirm_modal_title,
            'cancel_ride_confirm_modal_message' => $this->cancel_ride_confirm_modal_message,
            'cancel_ride_confirm_modal_no_btn_text' => $this->cancel_ride_confirm_modal_no_btn_text,
            'cancel_ride_confirm_modal_yes_btn_text' => $this->cancel_ride_confirm_modal_yes_btn_text,
