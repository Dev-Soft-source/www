...
class ProfileController extends Controller
{
    ...
    public function update($id, Request $request){
        ...
        $validator = Validator::make($request->all(),[
            ...
            'address.nullable' => 'The address may be null',
            'address.string' => 'The address must be a string',
            'address.max' => 'The address may not be greater than 100 characters',
            'state.required' => 'The state is required',
            'state.string' => 'The state must be a string',
            'state.max' => 'The state may not be greater than 25 characters',
            'city.required' => 'The city is required',
            'city.string' => 'The city must be a string',
            'city.max' => 'The city may not be greater than 25 characters',
            'zipcode.required' => 'The zip code is required',
            'zipcode.string' => 'The zip code must be a string',
            'zipcode.max' => 'The zip code may not be greater than 7 characters',
            'government_issued_id.nullable' => 'The government issued id may be null',
            'government_issued_id.file' => 'The government issued id must be a file',
            'government_issued_id.mimes' => 'The government issued id must be a file of type: jpeg, png, jpg, gif',
            'government_issued_id.max' => 'The government issued id must be less than 10MB',
