    ...
    public function index($lang = null){
        ...
        if ($selectedLanguage) {
            ...
            if ($selectedLanguage) {
                ...
                $studentPage = StudentPageSettingDetail::where('language_id', $selectedLanguage->id)->first();
        ...
        return view('students',['notificationPage'=>$notificationPage ,'successMessage'=>$successMessage,'studentPage' => $studentPage,'video' => $videoDetails,'notifications' => $notifications,'languages' => $languages,'selectedLanguage' => $selectedLanguage]);
    }
}
