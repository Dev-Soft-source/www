...
class VerifyStudentController extends Controller
{
    public function index($lang = null){
        ...
        $studentCardPage = MyStudentCardSettingDetail::getByLanguageWithFallback($this->selectedLanguage->id, $this->defaultLang->id);
        ...
        if (auth()->user()) {
            ...
            return view('verify_student',['reviewSetting' => $reviewSetting,'ProfilePage' => $ProfilePage,'ProfileSetting' => $ProfileSetting,
            'studentCardPage' => $studentCardPage,'user' => $user]);
        } else {
