    ...
    public function index($lang = null){
        ...
        if ($selectedLanguage) {
            ...
            if ($selectedLanguage) {
                ...
                $termsAndConditionPage = TermsAndConditionPageSettingDetail::where('language_id', $selectedLanguage->id)->first();
            }
        } else {
        ...
        return view('terms_and_conditions',['notificationPage'=>$notificationPage ,'successMessage'=>$successMessage,'termsAndConditionPage' => $termsAndConditionPage,'notifications' => $notifications,'languages' => $languages,'selectedLanguage' => $selectedLanguage]);
    }
}
