    ...
    public function index($lang = null){
        ...
        if ($selectedLanguage) {
            ...
            if ($selectedLanguage) {
                ...
                $privacyPolicyPage = PrivacyPolicyPageSettingDetail::where('language_id', $selectedLanguage->id)->first();
            }
        } else {
        ...
        return view('privacy_policy',['notificationPage'=>$notificationPage ,'successMessage'=>$successMessage,'privacyPolicyPage' => $privacyPolicyPage,'notifications' => $notifications,'languages' => $languages,'selectedLanguage' => $selectedLanguage]);
    }
}
