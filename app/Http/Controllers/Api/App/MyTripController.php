                    ...
                    if ($hoursDifference > 48) {
                        ...
                        foreach ($transactions as $transaction) {
                            ...
                            if (isset($getRefundEntryPrice) && !is_null($getRefundEntryPrice) && $getRefundEntryPrice == $checkPrice) {
                                ...
                                $transactionAmount = $ride->payment_method != $getPaymentMethodId ? (float)$transaction->price : (float)$transaction->booking_fee;
                        ...
                        if ($ride->payment_method != $getPaymentMethodId) {
                            ...
                            foreach ($transactions as $transaction) {
                                ...
                                if (isset($getRefundEntryPrice) && !is_null($getRefundEntryPrice) && $getRefundEntryPrice == ((float)$transaction->price - (float)$transaction->booking_fee)) {
                                    ...
                                    $transactionAmount = $ride->payment_method != $getPaymentMethodId ? ((float)$transaction->price - (float)$transaction->booking_fee) : (float)$transaction->booking_fee;
