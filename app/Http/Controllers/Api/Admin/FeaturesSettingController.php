...
class FeaturesSettingController extends Controller
{
     ...
     * Single-language mode: language_id required.
     */
    public function uploadExcel(Request $request)
    {
        try {
            ...
            try {
                Excel::import(new FeaturesSettingImport($isAllLanguages ? null : $request->language_id), $request->file('excel_file'));

                if ($isAllLanguages) {
                    return $this->successResponse([], 'Features settings for all languages uploaded successfully from Excel.');
                }
    ...
    public function downloadTemplate(Request $request)
    {
        try {
            ...
            $fileName = 'features_settings_template_' . date('Y-m-d') . '.xlsx';
            return Excel::download(
                new FeaturesSettingTemplateExport($format, $languages),
                $fileName
            );
        } catch (\Exception $e) {
