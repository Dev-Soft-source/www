...
class CoffeeWallPageSettingController extends Controller
{
    ...
    /**
     * Upload coffee wall page settings via Excel (all-languages format: Field Name + one column per language).
     */
    public function uploadExcel(Request $request)
    {
        try {
            ...
            try {
                Excel::import(new CoffeeWallPageSettingImport(null), $request->file('excel_file'));
                return $this->successResponse(
                    [],
                    'Coffee wall settings for all languages uploaded successfully from Excel.'
                );
    ...
    public function downloadTemplate(Request $request)
    {
        try {
            ...
            if ($format === 'all_languages') {
                ...
                $existingData = CoffeeWallPageSetting::with('coffeeWallPageSettingDetail')->first();
            }
            return Excel::download(
                new CoffeeWallPageSettingTemplateExport($format, $languages, $existingData),
