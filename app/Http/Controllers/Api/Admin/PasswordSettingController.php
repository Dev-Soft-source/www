...
class PasswordSettingController extends Controller
{
    ...
    /**
     * Upload Password settings via Excel (all-languages format: Field Name + one column per language).
     */
    public function uploadExcel(Request $request)
    {
        try {
            ...
            try {
                Excel::import(new PasswordSettingImport(null), $request->file('excel_file'));
                return $this->successResponse(
                    [],
                    'Password settings for all languages uploaded successfully from Excel.'
                );
    ...
    public function downloadTemplate(Request $request)
    {
        try {
            ...
            if ($format === 'all_languages') {
                ...
                $existingData = PasswordSetting::with('passwordSettingDetail')->first();
            }
            return Excel::download(
                new PasswordSettingTemplateExport($format, $languages, $existingData),
