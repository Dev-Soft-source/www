...
class LoginPageSettingController extends Controller
{
    ...
    /**
     * Upload login page settings via Excel (all-languages format: Field Name + one column per language).
     */
    public function uploadExcel(Request $request)
    {
        try {
            ...
            try {
                Excel::import(new LoginPageSettingImport(null), $request->file('excel_file'));
                return $this->successResponse(
                    [],
                    'Login page settings for all languages uploaded successfully from Excel.'
                );
    ...
    public function downloadTemplate(Request $request)
    {
        try {
            ...
            if ($format === 'all_languages') {
                ...
                $existingData = LoginPageSetting::with('loginPageSettingDetail')->first();
            }
            return Excel::download(
                new LoginPageSettingTemplateExport($format, $languages, $existingData),
