...
class LogoutSettingController extends Controller
{
    ...
    /**
     * Upload logout settings via Excel (all-languages format: Field Name + one column per language).
     */
    public function uploadExcel(Request $request)
    {
        try {
            ...
            try {
                Excel::import(new LogoutSettingImport(null), $request->file('excel_file'));
                return $this->successResponse(
                    [],
                    'Logout settings for all languages uploaded successfully from Excel.'
                );
    ...
    public function downloadTemplate(Request $request)
    {
        try {
            ...
            if ($format === 'all_languages') {
                ...
                $existingData = LogoutSetting::with('logoutSettingDetail')->first();
            }
            return Excel::download(
                new LogoutSettingTemplateExport($format, $languages, $existingData),
