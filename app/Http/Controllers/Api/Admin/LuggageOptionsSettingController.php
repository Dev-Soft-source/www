...
class LuggageOptionsSettingController extends Controller
{
    ...
    /**
     * Upload luggage options via Excel (all-languages format: Field Name + one column per language).
     */
    public function uploadExcel(Request $request)
    {
        try {
            ...
            try {
                Excel::import(new LuggageOptionsSettingImport(null), $request->file('excel_file'));
                return $this->successResponse(
                    [],
                    'Luggage options settings for all languages uploaded successfully from Excel.'
                );
    ...
    public function downloadTemplate(Request $request)
    {
        try {
            ...
            return Excel::download(
                new LuggageOptionsSettingTemplateExport($format, $languages),
