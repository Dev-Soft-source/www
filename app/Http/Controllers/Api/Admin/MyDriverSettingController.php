...
class MyDriverSettingController extends Controller
{
    ...
    /**
     * Upload my driver license settings via Excel (all-languages format: Field Name + one column per language).
     */
    public function uploadExcel(Request $request)
    {
        try {
            ...
            try {
                Excel::import(new MyDriverSettingImport(null), $request->file('excel_file'));
                return $this->successResponse(
                    [],
                    'My Driver License settings for all languages uploaded successfully from Excel.'
                );
    ...
    public function downloadTemplate(Request $request)
    {
        try {
            ...
            if ($format === 'all_languages') {
                ...
                $existingData = DriverSetting::with('driverSettingDetail')->first();
            }
            return Excel::download(
                new MyDriverSettingTemplateExport($format, $languages, $existingData),
