...
class MyPhoneSettingController extends Controller
{
    ...
    /**
     * Upload my phone settings via Excel (all-languages format: Field Name + one column per language).
     */
    public function uploadExcel(Request $request)
    {
        try {
            ...
            try {
                Excel::import(new MyPhoneSettingImport(null), $request->file('excel_file'));
                return $this->successResponse(
                    [],
                    'My Phone settings for all languages uploaded successfully from Excel.'
                );
    ...
    public function downloadTemplate(Request $request)
    {
        try {
            ...
            if ($format === 'all_languages') {
                ...
                $existingData = MyPhoneSetting::with('myPhoneSettingDetail')->first();
            }
            return Excel::download(
                new MyPhoneSettingTemplateExport($format, $languages, $existingData),
