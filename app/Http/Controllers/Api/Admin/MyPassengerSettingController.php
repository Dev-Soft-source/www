...
class MyPassengerSettingController extends Controller
{
    ...
    /**
     * Upload my passenger settings via Excel (all-languages format: Field Name + one column per language).
     */
    public function uploadExcel(Request $request)
    {
        try {
            ...
            try {
                Excel::import(new MyPassengerSettingImport(null), $request->file('excel_file'));
                return $this->successResponse(
                    [],
                    'My Passenger settings for all languages uploaded successfully from Excel.'
                );
    ...
    public function downloadTemplate(Request $request)
    {
        try {
            ...
            if ($format === 'all_languages') {
                ...
                $existingData = MyPassengerSetting::with('myPassengerSettingDetail')->first();
            }
            return Excel::download(
                new MyPassengerSettingTemplateExport($format, $languages, $existingData),
