...
class PassengerRewardPointController extends Controller
{
    use StatusResponser;

    public function index()
    {
        $rewardPointSettings = RewardPointSetting::query()->orderBy('id', 'asc')->where('type', 'passenger');
    ...
    public function destroy($id)
    {
        ...
        if ($rewardPointSetting) {
            $rewardPointSettings = RewardPointSetting::query()->orderBy('id', 'asc')->where('type', 'passenger')->get();
