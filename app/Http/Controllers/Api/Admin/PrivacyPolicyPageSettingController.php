...
class PrivacyPolicyPageSettingController extends Controller
{
    ...
    public function uploadExcel(Request $request)
    {
        try {
            ...
            try {
                Excel::import(new PrivacyPolicyPageSettingImport($request->language_id), $request->file('excel_file'));
                return $this->successResponse(['language' => $language->name], "Privacy Policy page settings for {$language->name} uploaded successfully from Excel.");
    ...
    {
        try {
            return Excel::download(new PrivacyPolicyPageSettingTemplateExport($request->get('format', 'single_column')),
