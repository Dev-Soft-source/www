...
class TermsOfUsePageSettingImport implements ToCollection, WithHeadingRow, WithValidation
{
    ...
    {
        $setting = TermsOfUsePageSetting::first() ?? TermsOfUsePageSetting::create([]);
        ...
        TermsOfUsePageSettingDetail::updateOrCreate(
            ['terms_use_page_id' => $setting->id, 'language_id' => $this->languageId],
            $payload
        );
    }
