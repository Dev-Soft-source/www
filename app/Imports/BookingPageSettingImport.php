...
class BookingPageSettingImport implements ToCollection, WithHeadingRow, WithValidation
{
    ...
    protected function processMultiColumnFormat($bookingPageSetting, $row)
    {
        ...
        $fields = [
            ...
            'seat_hold_alert_message' => $row['seat_hold_alert_message'] ?? null,
            'seat_hold_message' => $row['seat_hold_message'] ?? null,
            'seats_available_tooltip' => $row['seats_available_tooltip'] ?? null,
            'chat_with_driver_tooltip' => $row['chat_with_driver_tooltip'] ?? null,
            'aggreement_tooltip' => $row['aggreement_tooltip'] ?? null,
            'pink_ride_tooltip' => $row['pink_ride_tooltip'] ?? null,
            'extra_care_ride_tooltip' => $row['extra_care_ride_tooltip'] ?? null,
            ...
            'booking_disclaimer_firm_tooltip' => $row['booking_disclaimer_firm_tooltip'] ?? null,
            'fee_student_pending_text' => $row['fee_student_pending_text'] ?? null,
            'fee_charge_waived' => $row['fee_charge_waived'] ?? null,
            'coffee_wall_cash_text' => $row['coffee_wall_cash_text'] ?? null,
            'coffee_wall_online_payment_text' => $row['coffee_wall_online_payment_text'] ?? null,
            'coffee_wall_secure_cash_text' => $row['coffee_wall_secure_cash_text'] ?? null,
            'note_for_students_text' => $row['note_for_students_text'] ?? null,
            ...
            'user_declarations_label' => $row['user_declarations_label'] ?? null,
    ...
    public function rules(): array
    {
        ...
        if ($language->is_default == '1') {
            $rules = [
                ...
                'seats_available' => 'required|string',
                'seats_available_info_text' => 'required|string',
                'seat_hold_alert_message' => 'required|string',
                'seat_hold_message' => 'required|string',
                ...
                'booking_disclaimer_firm_tooltip' => 'required|string',
                ...
                'user_declarations_label' => 'required|string',
