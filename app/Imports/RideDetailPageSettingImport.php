...
class RideDetailPageSettingImport implements ToCollection, WithHeadingRow, WithValidation
{
    ...
    {
        return [
            'name','meta_keywords','meta_description','main_heading','from_label','to_label','at_label','co_passenger_label','ride_co_passenger_heading','trip_co_passenger_heading','payment_method_label','booking_price_label','booking_method_label','total_seats_label','seat_available_label','booking_type_label','cancellation_policy_label','luggage_label','smoking_label','pets_label','seats_left_label','per_seat_label','ride_features_label','ride_seat_label','all_seats_booked_label','ride_canceller_by_driver','ride_completed_text','ride_completed_label','ride_cancelled_label','ride_cancellation_limit_exceed','book_seat_btn_label','no_seat_available_label','no_ride_found_message','cancel_booking_btn_label','cancel_ride_btn_label','cancel_ride_confirmation','cancel_ride_yes_btn','cancel_ride_no_btn','edit_ride_btn_label','review_label','no_reviews_label','booking_request_heading','request_booking_label','seat_requested_label','request_accept_label','request_reject_label','secured_cash_heading','enter_code_label','enter_secured_placeholder','mobile_seat_booked_heading','mobile_seat_booked_label','mobile_seat_fare_label','mobile_seat_booking_fee_label','mobile_seat_total_amount_label','vehicle_info_label','driver_info_label','review_driver_info_label','review_passanger_label','driver_chat_with','driver_label','cancellation_policy','passengers_driven_label','driver_chat_heading','driver_chat_label','driver_chat_button_label','booking_table_heading','passenger_column_label','seat_booked_column_label','total_cost_column_label','booked_on_column_label','status_column_label','booking_requested_status_label','seat_booked_status_label','booking_denied_status_label','actions_column_label','edit_button_actions_label','review_button_label','i_reviewed_label','noon_label','midnight_label','driver_note_label','trip_main_heading','ride_main_heading','my_ride_page_heading_label','my_trip_page_heading_label','discount_label','booking_request_main_heading','passenger_age_label','passenger_gender_label','seat_on_column_label','cancellation_policy_tooltip','view_cancellation_tooltip','cancellation_policy_tooltip_url','pickup_dropoff_info_heading','pickup_at_label','dropoff_at_label','depends_on_other_stops_tooltip','departure_time_approximate_tooltip','stops_along_the_way_label','stop_date_label','description_label','verified_email','verified_phone','instant_btn_label','chat_error_message','empty_chat_placeholder'
        ];
    }
