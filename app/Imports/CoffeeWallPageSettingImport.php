...
class CoffeeWallPageSettingImport implements ToCollection, WithHeadingRow, WithValidation
{
    ...
    protected function processMultiColumnFormat($setting, $row)
    {
        $fields = [
            ...
            'agree_terms_error' => $row['agree_terms_error'] ?? null,
            'custom_amount_label' => $row['custom_amount_label'] ?? null,
            'pay_button_label' => $row['pay_button_label'] ?? null,
            'notify_coffee_used_label' => $row['notify_coffee_used_label'] ?? null,
            'select_payment_method_label' => $row['select_payment_method_label'] ?? null,
            'credit_card_label' => $row['credit_card_label'] ?? null,
            'paypal_label' => $row['paypal_label'] ?? null,
            'donation_acknowledgment_label' => $row['donation_acknowledgment_label'] ?? null,
            ...
            'contact_infomation_label' => $row['contact_infomation_label'] ?? null,
            'faq_donors_label' => $row['faq_donors_label'] ?? null,
            'faq_donors_1_question' => $row['faq_donors_1_question'] ?? null,
            'faq_donors_1_answer' => $row['faq_donors_1_answer'] ?? null,
            'faq_donors_2_question' => $row['faq_donors_2_question'] ?? null,
            'faq_donors_2_answer' => $row['faq_donors_2_answer'] ?? null,
            'faq_donors_3_question' => $row['faq_donors_3_question'] ?? null,
            'faq_donors_3_answer' => $row['faq_donors_3_answer'] ?? null,
            'faq_donors_4_question' => $row['faq_donors_4_question'] ?? null,
            'faq_donors_4_answer' => $row['faq_donors_4_answer'] ?? null,
            'faq_beneficiary_label' => $row['faq_beneficiary_label'] ?? null,
            'faq_beneficiary_1_question' => $row['faq_beneficiary_1_question'] ?? null,
            'faq_beneficiary_1_answer' => $row['faq_beneficiary_1_answer'] ?? null,
            'faq_beneficiary_2_question' => $row['faq_beneficiary_2_question'] ?? null,
            'faq_beneficiary_2_answer' => $row['faq_beneficiary_2_answer'] ?? null,
            'faq_beneficiary_3_question' => $row['faq_beneficiary_3_question'] ?? null,
            'faq_beneficiary_3_answer' => $row['faq_beneficiary_3_answer'] ?? null,
            'faq_beneficiary_4_question' => $row['faq_beneficiary_4_question'] ?? null,
            'faq_beneficiary_4_answer' => $row['faq_beneficiary_4_answer'] ?? null,
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'agree_terms_error' => 'required|string',
            ...
            'contact_infomation_label' => 'required|string',
            'faq_donors_label' => 'required|string',
            'faq_donors_1_question' => 'required|string',
            'faq_donors_1_answer' => 'required|string',
            'faq_donors_2_question' => 'required|string',
            'faq_donors_2_answer' => 'required|string',
            'faq_donors_3_question' => 'required|string',
            'faq_donors_3_answer' => 'required|string',
            'faq_donors_4_question' => 'required|string',
            'faq_donors_4_answer' => 'required|string',
            'faq_beneficiary_label' => 'required|string',
            'faq_beneficiary_1_question' => 'required|string',
            'faq_beneficiary_1_answer' => 'required|string',
            'faq_beneficiary_2_question' => 'required|string',
            'faq_beneficiary_2_answer' => 'required|string',
            'faq_beneficiary_3_question' => 'required|string',
            'faq_beneficiary_3_answer' => 'required|string',
            'faq_beneficiary_4_question' => 'required|string',
            'faq_beneficiary_4_answer' => 'required|string',
