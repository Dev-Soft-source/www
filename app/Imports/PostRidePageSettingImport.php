...
class PostRidePageSettingImport implements ToCollection, WithHeadingRow, WithValidation
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'price_error_paragraph_1' => 'required|string',
            'price_error_paragraph_2' => 'required|string',
            'price_error_paragraph_3' => 'required|string',
