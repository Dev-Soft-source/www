...
class MyDriverSettingTemplateExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths
{
    protected $format;
    ...
    /** @var \App\Models\DriverSetting|null */
     ...
     * @param \App\Models\DriverSetting|null $existingData - with driverSettingDetail loaded
     */
    ...
    protected function allLanguagesFormat(): Collection
    {
        ...
        $fields = static::getTranslatableFieldsWithDefaults();
        $detailsByLang = [];
        if ($this->existingData && $this->existingData->relationLoaded('driverSettingDetail')) {
            foreach ($this->existingData->driverSettingDetail as $d) {
