...
class ForgotPasswordPageSettingTemplateExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths
{
    protected $format;
    ...
    /** @var \App\Models\ForgotPasswordPageSetting|null */
     ...
     * @param \App\Models\ForgotPasswordPageSetting|null $existingData - with forgotPasswordPageSettingDetail loaded
     */
    ...
    {
        $fields = ['name', 'meta_keywords', 'meta_description', 'main_heading', 'main_label', 'email_error', 'button_label'];
    ...
    protected function allLanguagesFormat(): Collection
    {
        ...
        $fields = static::getTranslatableFieldsWithDefaults();
        $detailsByLang = [];
        if ($this->existingData && $this->existingData->relationLoaded('forgotPasswordPageSettingDetail')) {
            foreach ($this->existingData->forgotPasswordPageSettingDetail as $d) {
