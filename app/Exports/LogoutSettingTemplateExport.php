...
class LogoutSettingTemplateExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths
{
    protected $format;
    ...
    /** @var \App\Models\LogoutSetting|null */
     ...
     * @param \App\Models\LogoutSetting|null $existingData - with logoutSettingDetail loaded
     */
    ...
    {
        $fields = ['main_heading', 'confirmation_message_heading', 'confirmation_no_label', 'confirmation_yes_label'];
    ...
    protected function allLanguagesFormat(): Collection
    {
        ...
        $fields = static::getTranslatableFieldsWithDefaults();
        $detailsByLang = [];
        if ($this->existingData && $this->existingData->relationLoaded('logoutSettingDetail')) {
            foreach ($this->existingData->logoutSettingDetail as $d) {
