...
class LogoutSettingTemplateExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    protected $format;
    ...
    {
        return ['main_heading','confirmation_message_heading','confirmation_no_label','confirmation_yes_label'];
    }
}
