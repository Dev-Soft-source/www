...
class ProfilePhotoSettingTemplateExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths
{
    protected $format;
    ...
    {
        $fields = ['name', 'mobile_upload_photo_tooltip', 'mobile_upload_new_image_button_text', 'main_heading', 'save_button_text', 'upload_profile_photo_placeholder', 'choose_file_placeholder', 'images_option_placeholder', 'photo_error', 'mobile_indicate_required_field_label', 'sub_heading_text'];
