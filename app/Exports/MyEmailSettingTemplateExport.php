...
class MyEmailSettingTemplateExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths
{
    protected $format;
    ...
    /** @var \App\Models\MyEmailSetting|null */
     ...
     * @param \App\Models\MyEmailSetting|null $existingData - with myEmailSettingDetail loaded
     */
    ...
    protected function allLanguagesFormat(): Collection
    {
        ...
        $fields = static::getTranslatableFieldsWithDefaults();
        $detailsByLang = [];
        if ($this->existingData && $this->existingData->relationLoaded('myEmailSettingDetail')) {
            foreach ($this->existingData->myEmailSettingDetail as $d) {
