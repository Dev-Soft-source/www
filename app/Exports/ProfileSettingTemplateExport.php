...
class ProfileSettingTemplateExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithColumnWidths
{
    protected $format;
    ...
    /** @var \App\Models\ProfileSetting|null */
     ...
     * @param \App\Models\ProfileSetting|null $existingData - For all_languages (with profileSettingDetail loaded)
     */
    ...
    public static function getTranslatableFieldsWithDefaults(): array
    {
        return [
            ...
            'my_vehicles_label' => 'My Vehicles',
            'main_heading' => 'Profile',
            'password_label' => 'Password',
            'my_phone_number_label' => 'My Phone Number',
            'my_email_address_label' => 'My Email Address',
            'my_driver_license_label' => 'My Driver License',
            'my_student_card_label' => 'My Student Card',
    ...
    protected function allLanguagesFormat(): Collection
    {
        ...
        $detailsByLang = [];
        if ($this->existingData && $this->existingData->relationLoaded('profileSettingDetail')) {
            foreach ($this->existingData->profileSettingDetail as $d) {
