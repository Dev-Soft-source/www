...
class BookingPageSettingTemplateExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths
{
    ...
    public static function getTranslatableFieldsWithDefaults(): array
    {
        return [
            ...
            'seats_available' => '{0} No seats available|{1} :count seat available|[2,*] :count seats available',
            'seats_available_info_text' => 'Number of seats available for this ride',
            'seat_hold_alert_message' => 'Seat hold alert',
            'seat_hold_message' => 'Your selected seat(s) will be held for 10 minutes. If the booking is not completed within that time, the seat(s) will be released and made available to others.',
            ...
            'pay_and_request_to_book_btn_text' => 'Pay and Request to Book',
            ...
            'booking_disclaimer_firm_tooltip' => 'Firm booking cannot be cancelled or refunded.',

            'fee_student_pending_text' => 'Your student verification is pending. Pay the Booking Fee now to secure your seat, and we will refund it automatically once your status is approved (usually within 72 hours).',
            'fee_charge_waived' => 'As a verified student, your booking fee is waived. You only pay the booking price.',
            'coffee_wall_cash_text' => 'To be paid in cash directly to the driver at the time of the ride.',
            'coffee_wall_online_payment_text' => 'ProximaRide will transfer this amount to the driver only after the ride is completed.',
            'coffee_wall_secure_cash_text' => 'This amount is pre-authorized to ProximaRide now and will be refunded to you once you meet the driver and pay them in cash.',
            'note_for_students_text' => '<strong>Note for Students:</strong> You are limited to booking a maximum of 2 seats per ride for Cash payment rides.',
            ...
            'user_declarations_label' => 'User declarations',
