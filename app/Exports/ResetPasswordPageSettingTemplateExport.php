...
class ResetPasswordPageSettingTemplateExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithColumnWidths
{
    protected $format;
    ...
    /** @var \App\Models\ResetPasswordPageSetting|null */
     ...
     * @param \App\Models\ResetPasswordPageSetting|null $existingData - For all_languages (with resetPasswordPageSettingDetail loaded)
     */
    ...
    public static function getTranslatableFieldsWithDefaults(): array
    {
        return [
            ...
            'meta_description' => 'Reset password page',
            'main_heading' => 'Reset Password',
            'main_label' => 'Enter your new password',
    ...
    protected function allLanguagesFormat(): Collection
    {
        ...
        $detailsByLang = [];
        if ($this->existingData && $this->existingData->relationLoaded('resetPasswordPageSettingDetail')) {
            foreach ($this->existingData->resetPasswordPageSettingDetail as $d) {
