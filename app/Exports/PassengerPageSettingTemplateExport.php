...
class PassengerPageSettingTemplateExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths
{
    protected $format;
    ...
    /** @var \App\Models\PassengerPageSetting|null */
    ...
    {
        $fields = ['name','meta_keywords','meta_description','main_heading','sub_heading','page_description'];
    ...
    protected function allLanguagesFormat(): Collection
    {
        ...
        $fields = static::getTranslatableFieldsWithDefaults();
        $detailsByLang = [];
        if ($this->existingData && $this->existingData->relationLoaded('passengerPageSettingDetail')) {
            foreach ($this->existingData->passengerPageSettingDetail as $d) {
