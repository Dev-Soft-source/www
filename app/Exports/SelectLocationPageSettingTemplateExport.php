...
class SelectLocationPageSettingTemplateExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithColumnWidths
{
    protected $format;
    ...
    /** @var SelectLocationSetting|null */
    ...
    public static function getTranslatableFieldsWithDefaults(): array
    {
        return [
            ...
            'search_origin_label' => 'Search origin',
            'no_origin_label' => 'No origin',
            'select_destination_label' => 'Select destination',
            'search_destination_label' => 'Search destination',
            'no_destination_label' => 'No destination',
            ...
            'select_state_first_label' => 'Select state first',
            'search_state_label' => 'Search state',
            'no_state_label' => 'No state',
            'select_city_label' => 'Select city',
            'search_city_label' => 'Search city',
    ...
    protected function allLanguagesFormat(): Collection
    {
        ...
        $detailsByLang = [];
        if ($this->existingData && $this->existingData->relationLoaded('selectLocationSettingDetail')) {
            foreach ($this->existingData->selectLocationSettingDetail as $d) {
