...
class HomePageSettingTemplateExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    protected $format;
    ...
    public function collection(): Collection
    {
        ...
        if ($this->format === 'single_column') {
            ...
            foreach ($fields as $field) {
                $prefill = $defaults[$field] ?? '';
                $data[] = ['field_name' => $field, 'translation_value' => $prefill];
            }
    ...
    protected function getDefaultFileFieldValues(): array
    {
        ...
        foreach ($fileFields as $field) {
            if (!empty($detail->$field)) $defaults[$field] = $detail->$field;
        }
        return $defaults;
    }
}
