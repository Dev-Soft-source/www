...
class HomePageSettingTemplateExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths
{
    protected $format;
    ...
    /** @var \App\Models\HomePageSetting|null */
     ...
     * @param \App\Models\HomePageSetting|null $existingData - with homePageSettingDetail loaded
     */
    ...
    protected function allLanguagesFormat(): Collection
    {
        ...
        $fields = static::getTranslatableFieldsWithDefaults();
        $detailsByLang = [];
        if ($this->existingData && $this->existingData->relationLoaded('homePageSettingDetail')) {
            foreach ($this->existingData->homePageSettingDetail as $d) {
    ...
    {
        $fileFields = [
            'slider_image','from_field_icon','swap_field_icon','to_field_icon','date_field_icon','search_field_icon','section1_pink_rides_image','section1_folks_rides_image','section1_customize_image','section2_profile_verification_image','section2_policies_image','section2_car_insurance_image','section2_help_image','section3_safe_image','section3_affordable_image','section3_reliable_image','movement_section_icon','news_section_icon1','news_section_icon2','news_section_icon3','news_section_icon4','use_section_point1_image','use_section_point2_image','use_section_point3_image','use_section_point4_image','payment_section_icon1','payment_section_icon2','payment_section_icon3','payment_section_icon4','doing_section_slider_image','reasons_section_members_image','reasons_section_driver_image','reasons_section_quality_image','reasons_section_policy_image','reasons_section_students_image','reasons_section_safety_image','reasons_section_price_image','reasons_section_use_image','reasons_section_reliable_image','reasons_section_responsible_image'
        ];
        $defaults = [];
