...
class MyPassengerSettingTemplateExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths
{
    protected $format;
    ...
    /** @var \App\Models\MyPassengerSetting|null */
     ...
     * @param \App\Models\MyPassengerSetting|null $existingData - with myPassengerSettingDetail loaded
     */
    ...
    protected function allLanguagesFormat(): Collection
    {
        ...
        $fields = static::getTranslatableFieldsWithDefaults();
        $detailsByLang = [];
        if ($this->existingData && $this->existingData->relationLoaded('myPassengerSettingDetail')) {
            foreach ($this->existingData->myPassengerSettingDetail as $d) {
