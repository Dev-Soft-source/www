...
class CoffeeWallPageSettingTemplateExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths
{
    ...
    public static function getTranslatableFieldsWithDefaults(): array
    {
        return [
            ...
            'select_payment_method_label' => 'Select Your Payment Method',
            'credit_card_label' => 'Debit or Credit Card',
            'paypal_label' => 'PayPal',
            'donation_acknowledgment_label' => 'I understand that my contribution is a voluntary act of kindness. As such, it is considered a donation and is non-refundable.',
            ...
            'contact_infomation_label' => 'Contact information',
            'faq_donors_label' => 'FAQ for donors',
            'faq_donors_1_question' => 'How do I donate?',
            'faq_donors_1_answer' => 'Choose an amount and complete payment.',
            'faq_donors_2_question' => 'Is my donation refundable?',
            'faq_donors_2_answer' => 'No, donations are non-refundable.',
            'faq_donors_3_question' => 'Can I donate more than once?',
            'faq_donors_3_answer' => 'Yes, you can donate any time.',
            'faq_donors_4_question' => 'Will I get notified when it is used?',
            'faq_donors_4_answer' => 'You can opt in to notifications during checkout.',
            'faq_beneficiary_label' => 'FAQ for beneficiaries',
            'faq_beneficiary_1_question' => 'Who can receive support?',
            'faq_beneficiary_1_answer' => 'Eligible beneficiaries can request available support.',
            'faq_beneficiary_2_question' => 'How do I redeem support?',
            'faq_beneficiary_2_answer' => 'Follow the redemption instructions provided to you.',
            'faq_beneficiary_3_question' => 'Is there a limit?',
            'faq_beneficiary_3_answer' => 'Limits depend on available donor contributions.',
            'faq_beneficiary_4_question' => 'Can I contact someone for help?',
            'faq_beneficiary_4_answer' => 'Yes, use the contact information provided on the page.',
